...
class CoordTransform {
     ...
     */
    static wgs84ToTencent(wgLat: number, wgLon: number): Coordinate {
        // 如果坐标在国外，直接返回
     ...
     */
    static tencentToWgs84(tcLat: number, tcLon: number): Coordinate {
        // 如果坐标在国外，直接返回
    ...
    static batchConvertCoordinates(devices: Array<UTSJSONObject>, targetSystem: string = 'tencent'): Array<UTSJSONObject> {
        ...
        return devices.map(device => {
            ...
            const item = device as UTSJSONObject
            ...
            let converted: Coordinate = { lat: lat, lng: lng }
     ...
     */
    static convertCoordinate(lat: number, lng: number, fromSystem: string = 'wgs84', toSystem: string = 'tencent'): Coordinate {
