...
type TabPayload = { __$originalPosition?: UTSSourceMapPosition<"TabPayload", "uni_modules/i-ui-x/components/i-tabs/i-tabs.uvue", 56, 6>; index: number, name: string, value: string, item: any }
