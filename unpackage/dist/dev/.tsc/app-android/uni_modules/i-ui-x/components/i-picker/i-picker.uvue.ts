...
type IPickerItem = { __$originalPosition?: UTSSourceMapPosition<"IPickerItem", "uni_modules/i-ui-x/components/i-picker/i-picker.uvue", 280, 6>;
  text : string,
  value : any | null,
  disabled : boolean,
}
...
function normalizeItem(item : any | null) : IPickerItem {
  if (item != null && typeof item == 'object') {
    ...
    const object = UTSAndroid.consoleDebugError(JSON.parse(serialized), " at uni_modules/i-ui-x/components/i-picker/i-picker.uvue:300") as UTSJSONObject
