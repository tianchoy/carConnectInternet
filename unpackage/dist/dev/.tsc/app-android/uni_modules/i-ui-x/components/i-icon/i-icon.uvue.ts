...
type IIconClickEvent = { __$originalPosition?: UTSSourceMapPosition<"IIconClickEvent", "uni_modules/i-ui-x/components/i-icon/i-icon.uvue", 82, 6>;
  name: string
  code: string
  label: string
}
