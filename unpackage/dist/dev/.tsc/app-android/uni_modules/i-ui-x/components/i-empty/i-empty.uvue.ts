...
const wrapStyle = computed(() : string => 'padding:' + formatBoxSize(props.padding) + ';background-color:' + bgColor.value + ';')
const iconStyle = computed(() : string => 'font-size:' + formatSize(props.iconSize) + ';color:' + props.iconColor + ';')
const textStyle = computed(() : string => 'color:' + props.textColor + ';')
const descStyle = computed(() : string => 'color:' + props.descriptionColor + ';')
const buttonStyle = computed(() : string => 'background-color:' + props.buttonColor + ';')
const buttonTextStyle = computed(() : string => 'color:' + props.buttonTextColor + ';')
