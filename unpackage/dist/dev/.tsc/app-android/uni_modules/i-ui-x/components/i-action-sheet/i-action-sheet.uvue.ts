...
type ActionPayload = { __$originalPosition?: UTSSourceMapPosition<"ActionPayload", "uni_modules/i-ui-x/components/i-action-sheet/i-action-sheet.uvue", 81, 6>; index: number, item: any, name: string, value: string }
