...
function collectValues(): UTSJSONObject {
  const values = { __$originalPosition: new UTSSourceMapPosition("values", "uni_modules/i-ui-x/components/i-form/i-form.uvue", 200, 9), } as UTSJSONObject
...
function submit(): void {
  ...
  const result = {__$originalPosition: new UTSSourceMapPosition("result", "uni_modules/i-ui-x/components/i-form/i-form.uvue", 316, 9),
    valid: isValid,
    values: collectValues(),
    errors: errors.value,
    message: message.value,
