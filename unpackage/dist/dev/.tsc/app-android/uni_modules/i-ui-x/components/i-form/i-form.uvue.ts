...
type IFormField = { __$originalPosition?: UTSSourceMapPosition<"IFormField", "uni_modules/i-ui-x/components/i-form/i-form.uvue", 122, 6>;
  name : string,
  label : string,
  value : any | null,
  hasValue : boolean,
...
type IFormError = { __$originalPosition?: UTSSourceMapPosition<"IFormError", "uni_modules/i-ui-x/components/i-form/i-form.uvue", 131, 6>;
  field : string,
  message : string,
}

type IFormValidatePayload = { __$originalPosition?: UTSSourceMapPosition<"IFormValidatePayload", "uni_modules/i-ui-x/components/i-form/i-form.uvue", 136, 6>;
  valid : boolean,
  message : string,
...
type IFormSubmitPayload = { __$originalPosition?: UTSSourceMapPosition<"IFormSubmitPayload", "uni_modules/i-ui-x/components/i-form/i-form.uvue", 143, 6>;
  valid : boolean,
  values : UTSJSONObject,
  errors : Array<IFormError>,
  message : string,
...
type IFormResetPayload = { __$originalPosition?: UTSSourceMapPosition<"IFormResetPayload", "uni_modules/i-ui-x/components/i-form/i-form.uvue", 150, 6>;
  values : UTSJSONObject,
}

type IFormScrollPayload = { __$originalPosition?: UTSSourceMapPosition<"IFormScrollPayload", "uni_modules/i-ui-x/components/i-form/i-form.uvue", 154, 6>;
  field : string,
  targetId : string,
  selector : string,
  offsetTop : number,
...
function collectValues() : UTSJSONObject {
  const values : UTSJSONObject = {__$originalPosition: new UTSSourceMapPosition("values", "uni_modules/i-ui-x/components/i-form/i-form.uvue", 229, 9),}
