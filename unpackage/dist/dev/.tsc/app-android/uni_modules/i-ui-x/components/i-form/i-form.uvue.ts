...
function collectValues() {
  const values = {__$originalPosition: new UTSSourceMapPosition("values", "uni_modules/i-ui-x/components/i-form/i-form.uvue", 184, 9),}
...
function submit() {
  ...
  const result = {__$originalPosition: new UTSSourceMapPosition("result", "uni_modules/i-ui-x/components/i-form/i-form.uvue", 246, 9),
    valid: isValid,
    values: collectValues(),
    errors: errors.value,
    message: message.value,
