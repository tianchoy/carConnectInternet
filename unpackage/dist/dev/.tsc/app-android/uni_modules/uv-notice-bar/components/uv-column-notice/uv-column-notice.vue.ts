	...
	const __sfc__ = defineComponent({
		...
		computed: {
			// 文字内容的样式
			textStyle() {
				let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-notice-bar/components/uv-column-notice/uv-column-notice.vue", 96, 9),}
			...
			swiperStyle(){
				const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-notice-bar/components/uv-column-notice/uv-column-notice.vue", 108, 11),};
