...
const _cache = __ins.renderCache;
	...
	onLoad((options: OnLoadOptions)=>{
		const param = UTSAndroid.consoleDebugError(JSON.parseObject(`${options['param'] ?? '{}'}`), " at uni_modules/lime-action-sheet/pages/index.uvue:103")!
	...
	const onClose = ()=>{
		uni.closeDialogPage({
			...
			fail(err){
				console.log('err', err, " at uni_modules/lime-action-sheet/pages/index.uvue:172")
			}
		})
