...
const __sfc__ = defineComponent({
  ...
  props: /*#__PURE__*/mergeModels({
    ...
    radius: { type: [String, Number, Array as PropType<Array>], required: false }
  }, {
...
const GenUniModulesLimePopupComponentsLPopupLPopupStyles = [_uM([["l-popup", _uM([["", _uM([["position", "fixed"], ["transitionDuration", "300ms"], ["transitionProperty", "transform,opacity"], ["transitionTimingFunction", "ease"], ["backgroundColor", "var(--l-popup-bg-color, #fff)"], ["overflow", "visible"], ["opacity", 1]])], [".l-popup-fade-enter", _uM([["opacity", 0]])], [".l-popup-fade-leave-to", _uM([["opacity", 0]])], [".l-popup-fade-enter.l-popup--top", _uM([["transform", "scale(1) translate(0, -100%)"]])], [".l-popup-fade-leave-to.l-popup--top", _uM([["transform", "scale(1) translate(0, -100%)"]])], [".l-popup-fade-enter.l-popup--bottom", _uM([["transform", "scale(1) translate(0, 100%)"]])], [".l-popup-fade-leave-to.l-popup--bottom", _uM([["transform", "scale(1) translate(0, 100%)"]])], [".l-popup-fade-enter.l-popup--left", _uM([["transform", "scale(1) translate(-100%, 0)"]])], [".l-popup-fade-leave-to.l-popup--left", _uM([["transform", "scale(1) translate(-100%, 0)"]])], [".l-popup-fade-enter.l-popup--right", _uM([["transform", "scale(1) translate(100%, 0)"]])], [".l-popup-fade-leave-to.l-popup--right", _uM([["transform", "scale(1) translate(100%, 0)"]])], [".l-popup-fade-enter.l-popup--center", _uM([["transform", "translate(-50%, -50%) scale(0.6)"], ["opacity", 0]])], [".l-popup-fade-leave-to.l-popup--center", _uM([["transform", "translate(-50%, -50%) scale(0.6)"], ["opacity", 0]])], [".l-dialog-enter.l-popup--center", _uM([["transform", "scale(0.6) translate(-50%, -50%)"], ["opacity", 0]])], [".l-dialog-leave-to.l-popup--center", _uM([["transform", "scale(0.6) translate(-50%, -50%)"], ["opacity", 0]])]])], ["l-popup__close", _pS(_uM([["position", "absolute"], ["top", 0], ["right", 0], ["paddingTop", 10], ["paddingRight", 10], ["paddingBottom", 10], ["paddingLeft", 10]]))], ["l-popup__close-icon", _pS(_uM([["color", "var(--l-popup-close-icon-color, #000000A6)"]]))], ["l-popup--top", _pS(_uM([["top", 0], ["left", 0], ["right", 0], ["borderBottomLeftRadius", "var(--l-popup-border-radius, 9px)"], ["borderBottomRightRadius", "var(--l-popup-border-radius, 9px)"], ["transform", "scale(1) translate(0, 0)"]]))], ["l-popup--bottom", _pS(_uM([["bottom", 0], ["left", 0], ["right", 0], ["borderTopLeftRadius", "var(--l-popup-border-radius, 9px)"], ["borderTopRightRadius", "var(--l-popup-border-radius, 9px)"], ["transform", "scale(1) translate(0, 0)"]]))], ["l-popup--safe-top", _pS(_uM([["paddingTop", "var(--uni-safe-area-inset-top)"]]))], ["l-popup--safe-bottom", _pS(_uM([["paddingBottom", "var(--uni-safe-area-inset-bottom)"]]))], ["l-popup--left", _pS(_uM([["top", 0], ["left", 0], ["bottom", 0], ["transform", "scale(1) translate(0, 0)"]]))], ["l-popup--right", _pS(_uM([["top", 0], ["right", 0], ["bottom", 0], ["transform", "scale(1) translate(0, 0)"]]))], ["l-popup--center", _pS(_uM([["top", "50%"], ["left", "50%"], ["transform", "translate(-50%, -50%) scale(1)"], ["transformOrigin", "50% 50%"], ["borderTopLeftRadius", "var(--l-popup-border-radius, 9px)"], ["borderTopRightRadius", "var(--l-popup-border-radius, 9px)"], ["borderBottomRightRadius", "var(--l-popup-border-radius, 9px)"], ["borderBottomLeftRadius", "var(--l-popup-border-radius, 9px)"]]))], ["@TRANSITION", _uM([["l-popup", _uM([["duration", "300ms"], ["property", "transform,opacity"], ["timingFunction", "ease"]])]])]])]
