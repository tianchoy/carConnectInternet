	...
	const __sfc__ = defineComponent({
		...
		computed: {
			...
			switchStyle() {
				let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-switch/components/uv-switch/uv-switch.vue", 93, 9),}
			...
			nodeStyle() {
				let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-switch/components/uv-switch/uv-switch.vue", 106, 9),}
			...
			bgStyle() {
				let style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-switch/components/uv-switch/uv-switch.vue", 115, 9),}
