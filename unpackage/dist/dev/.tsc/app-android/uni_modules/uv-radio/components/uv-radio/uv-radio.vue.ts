	...
	const __sfc__ = defineComponent({
		...
		computed: {
			...
			iconWrapStyle() {
				// radio的整体样式
				const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-radio/components/uv-radio/uv-radio.vue", 161, 11),}
			...
			radioStyle() {
				const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-radio/components/uv-radio/uv-radio.vue", 173, 11),}
