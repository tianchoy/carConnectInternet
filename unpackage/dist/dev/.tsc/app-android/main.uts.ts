...
export class UniCloudConfig extends io.dcloud.unicloud.InternalUniCloudConfig {
    ...
    override debuggerInfo ?: string = "{\"address\":[\"127.0.0.1\",\"192.168.1.180\"],\"servePort\":7002,\"debugPort\":9001,\"initialLaunchType\":\"remote\",\"skipFiles\":[\"<node_internals>/**\",\"/Applications/HBuilderX-Alpha.app/Contents/HBuilderX/plugins/unicloud/**/*.js\"]}"
