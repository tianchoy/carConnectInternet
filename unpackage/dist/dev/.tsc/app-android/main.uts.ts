...
export class UniAppConfig extends io.dcloud.uniapp.appframe.AppConfig {
    override name: string = "carConnectInternet"
...
import GenPagesSignUpSignUpClass from './pages/signUp/signUp.uvue'
...
__uniRoutes.push({ path: "pages/signUp/signUp", component: GenPagesSignUpSignUpClass, meta: { isQuit: false } as UniPageMeta, style: _uM([["navigationBarTitleText","注册"]]) } as UniPageRoute)
