...
import { showAppToast } from '../../../utils/toast.uts'
	...
	type UserInfo = { __$originalPosition?: UTSSourceMapPosition<"UserInfo", "pages/userCenter/editPassword/editPassword.uvue", 33, 7>;
		id : string,
		mobile : string,
	}
	type FormInstance = { __$originalPosition?: UTSSourceMapPosition<"FormInstance", "pages/userCenter/editPassword/editPassword.uvue", 37, 7>;
		validate: () => boolean
	}
...
const userInfo = ref<UserInfo>({
	...
	const handleSubmit = async () => {
		try {
			...
			const submitData = {__$originalPosition: new UTSSourceMapPosition("submitData", "pages/userCenter/editPassword/editPassword.uvue", 78, 10),
	...
	onLoad((options) => {
		if (options.userInfo != null) {
			try {
				const parsedInfo = UTSAndroid.consoleDebugError(JSON.parse(UTSAndroid.consoleDebugError(decodeURIComponent(options.userInfo as string), " at pages/userCenter/editPassword/editPassword.uvue:119") as string), " at pages/userCenter/editPassword/editPassword.uvue:119") as UTSJSONObject
