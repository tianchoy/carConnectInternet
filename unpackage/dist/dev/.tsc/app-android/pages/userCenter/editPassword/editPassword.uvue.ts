	...
	onLoad((options) => {
		if (options.userInfo) {
			try {
				...
				console.log("用户信息:", userInfo.value, " at pages/userCenter/editPassword/editPassword.uvue:132")
			} catch (e) {
				console.error("解析用户信息失败:", e, " at pages/userCenter/editPassword/editPassword.uvue:134")
			}
		}
	})
