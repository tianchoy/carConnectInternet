...
const _component_camera = resolveComponent("camera")
  ...
  return _cE("view", _uM({ class: "container" }), [
    ...
    _cE("view", _uM({ class: "tip" }), "请将IMEI码放入框内,自动扫描")
  ])
}
}
...
const GenPagesScancodeScancodeStyles = [_uM([["container", _pS(_uM([["height", "100%"], ["display", "flex"], ["flexDirection", "column"], ["backgroundColor", "#000000"]]))], ["scancode-box", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["paddingTop", 0], ["paddingRight", 0], ["paddingBottom", 0], ["paddingLeft", 0]]))], ["scan-code", _pS(_uM([["width", "100%"], ["height", "100%"]]))], ["tip", _pS(_uM([["position", "fixed"], ["bottom", "100rpx"], ["left", 0], ["right", 0], ["textAlign", "center"], ["color", "#ffffff"], ["fontSize", "28rpx"], ["backgroundColor", "rgba(0,0,0,0.5)"], ["paddingTop", "20rpx"], ["paddingRight", "20rpx"], ["paddingBottom", "20rpx"], ["paddingLeft", "20rpx"]]))]])]
