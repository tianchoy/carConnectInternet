...
import { openLocation } from '../../utils/openLocation.uts'
	...
	type MapCenter = { __$originalPosition?: UTSSourceMapPosition<"MapCenter", "pages/carInfoDetail/carInfoDetail.uvue", 125, 7>;
		latitude: number
		longitude: number
	}
	type SignalDetail = { __$originalPosition?: UTSSourceMapPosition<"SignalDetail", "pages/carInfoDetail/carInfoDetail.uvue", 204, 7>;
		experience: string
		quality: string
		color: string
		level: number
...
const deptId = ref<string | null>('')
	...
	const manualRefresh = async () => {
		...
		try {
			...
			console.error('手动刷新失败:', error, " at pages/carInfoDetail/carInfoDetail.uvue:512");
			showAppToast({
				title: '刷新失败',
				icon: 'none'
			});
      ...
      _cE("view", _uM({ class: "tools-panel" }), [
        _cE("view", _uM({ class: "imei-box" }), [
          ...
          _cE("view", _uM({ class: "pos-date" }), [
            _cE("text", _uM({ class: "time-item" }), "定位时间: " + _tD(unref(datainfo).positionUpdateTime), 1 /* TEXT */),
            _cE("text", _uM({ class: "time-item" }), "通信时间: " + _tD(unref(datainfo).signalUpdateTime), 1 /* TEXT */)
          ]),
          _cE("view", _uM({ class: "pos-adress" }), [
            _cE("view", _uM({ class: "address-row" }), [
              _cE("text", _uM({
                class: "address-label",
          ...
          _cE("view", _uM({ class: "signal-container" }), [
            _cE("view", _uM({ class: "signal-item" }), [
            ...
            _cE("view", _uM({ class: "satellite-item-h" }), [
              _cE("image", _uM({
                class: "satellite-icon",
                src: "/static/sate.png"
              })),
              _cE("text", _uM({ class: "satellite-text" }), _tD(unref(signalSat) || 0), 1 /* TEXT */)
            ]),
            _cE("view", _uM({ class: "power" }), [
              _cE("image", _uM({
                class: "power-icon",
                src: "/static/v.png"
              })),
              _cE("text", _uM({ class: "satellite-text" }), _tD(unref(carVoltage) || 0) + "∨", 1 /* TEXT */)
            ]),
            _cE("view", _uM({
              class: "battery",
