...
import { ref, onMounted } from 'vue'
	...
	// 定义表单类型
	type FormData = { __$originalPosition?: UTSSourceMapPosition<"FormData", "pages/signUp/signUp.uvue", 27, 7>;
		mobile : string
		password : string
	}

	type UvFormInstance = { __$originalPosition?: UTSSourceMapPosition<"UvFormInstance", "pages/signUp/signUp.uvue", 32, 7>;
...
const _cache = __ins.renderCache;
	...
	const rules = {__$originalPosition: new UTSSourceMapPosition("rules", "pages/signUp/signUp.uvue", 46, 8),
		mobile: [
			{
				required: true,
				message: '请输入手机号码',
	...
	const getSystemInfo = () => {
		...
		console.log(res, " at pages/signUp/signUp.uvue:92")
	...
	const submit = () => {
		...
		const newFormData = {__$originalPosition: new UTSSourceMapPosition("newFormData", "pages/signUp/signUp.uvue", 116, 9),
			...form.value,
			deviceModel:deviceModel.value
		}
			console.log('表单数据:', newFormData, " at pages/signUp/signUp.uvue:120")
		}).catch(errors => {
			uni.showToast({
				icon: 'error',
				title: '校验失败'
			})
			console.error('验证错误:', errors, " at pages/signUp/signUp.uvue:126")
		})
	}
