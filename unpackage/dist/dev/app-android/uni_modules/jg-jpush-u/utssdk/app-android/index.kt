...
open class PushService : JCommonService, IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PushService", "uni_modules/jg-jpush-u/utssdk/app-android/PushService.uts", 10, 14)
    }
    constructor() : super() {
        console.log("U-PushService", "constructor called", " at uni_modules/jg-jpush-u/utssdk/app-android/PushService.uts:15")
    }
}
val TAG = "JPUSH-uni-"
open class EventCallbackManager : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("EventCallbackManager", "uni_modules/jg-jpush-u/utssdk/app-android/index.uts", 11, 7)
    }
    ...
    open fun setEventCallBack(param: EventCallBackParams): Unit {
        console.log(TAG, "setEventCallBack", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:21")
        this.callBack = param
        if (this.cachedEvents.length > 0) {
            console.log(TAG, "处理缓存事件，数量:", this.cachedEvents.length, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:26")
            run {
                var i: Number = 0
    ...
    open fun triggerCallBack(event: EventCallBack): Unit {
        ...
        if (callBack != null) {
            console.log(TAG, "触发回调", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:37")
            val callback = callBack.callback
            if (callback != null) {
                callback(event)
            } else {
                console.log(TAG, "未设置回调函数，事件内容：", event, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:42")
            }
        } else {
            console.log(TAG, "回调未设置，缓存事件", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:45")
...
val init = fun(appKey: String?) {
    ...
    if (appKey != null && appKey != "") {
        console.log(TAG, "init with dynamic appKey", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:66")
        val config = JPushConfig()
        config.setjAppKey(appKey)
        JPushInterface.init(UTSAndroid.getAppContext(), config)
    } else {
        console.log(TAG, "init with manifest AppKey", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:72")
        JPushInterface.init(UTSAndroid.getAppContext())
    }
}
val setDebug = fun(debug: Boolean) {
    console.log(TAG, "setDebug", debug, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:78")
    JPushInterface.setDebugMode(debug)
}
val resumePush = fun() {
    console.log(TAG, "resumePush", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:83")
    JPushInterface.resumePush(UTSAndroid.getAppContext())
}
val stopPush = fun() {
    console.log(TAG, "stopPush", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:88")
    JPushInterface.stopPush(UTSAndroid.getAppContext())
}
val isPushStopped = fun(): Boolean {
    console.log(TAG, "isPushStopped", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:93")
    return JPushInterface.isPushStopped(UTSAndroid.getAppContext())
}
val getPushStatus = fun() {
    console.log(TAG, "getPushStatus", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:98")
    return JPushInterface.getPushStatus(UTSAndroid.getAppContext())
}
val setChannel = fun(channel: String) {
    console.log(TAG, "setChannel", channel, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:104")
    JPushInterface.setChannel(UTSAndroid.getAppContext(), channel)
}
val getRegistrationId = fun(): String {
    console.log(TAG, "getRegistrationId", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:109")
    return JPushInterface.getRegistrationID(UTSAndroid.getAppContext())
}
val setLatestNotificationNumber = fun(maxNum: Int) {
    console.log(TAG, "setLatestNotificationNumber", maxNum, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:115")
    JPushInterface.setLatestNotificationNumber(UTSAndroid.getAppContext(), maxNum)
}
val clearNotificationAll = fun() {
    console.log(TAG, "clearNotificationAll", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:120")
    JPushInterface.clearAllNotifications(UTSAndroid.getAppContext())
}
val clearNotificationById = fun(notificationId: Int) {
    console.log(TAG, "clearNotificationById", notificationId, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:125")
...
val setTags = fun(sequence: Int, tags: UTSArray<String>) {
    console.log(TAG, "setTags", sequence, tags, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:130")
...
val addTags = fun(sequence: Int, tags: UTSArray<String>) {
    console.log(TAG, "addTags", sequence, tags, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:140")
    val tagSet = Set<String>()
    run {
        var i: Number = 0
        while(i < tags.length){
...
val deleteTags = fun(sequence: Int, tags: UTSArray<String>) {
    console.log(TAG, "deleteTags", sequence, tags, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:150")
    val tagSet = Set<String>()
    run {
        var i: Number = 0
        while(i < tags.length){
...
val cleanTags = fun(sequence: Int) {
    console.log(TAG, "cleanTags", sequence, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:160")
    JPushInterface.cleanTags(UTSAndroid.getAppContext(), sequence)
}
val getAllTags = fun(sequence: Int) {
    console.log(TAG, "getAllTags", sequence, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:165")
    JPushInterface.getAllTags(UTSAndroid.getAppContext(), sequence)
}
val checkTagBindState = fun(sequence: Int, tag: String) {
    console.log(TAG, "checkTagBindState", sequence, tag, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:170")
    JPushInterface.checkTagBindState(UTSAndroid.getAppContext(), sequence, tag)
}
val setAlias = fun(sequence: Int, alias: String) {
    console.log(TAG, "setAlias", sequence, alias, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:175")
    JPushInterface.setAlias(UTSAndroid.getAppContext(), sequence, alias)
}
val deleteAlias = fun(sequence: Int) {
    console.log(TAG, "deleteAlias", sequence, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:180")
    JPushInterface.deleteAlias(UTSAndroid.getAppContext(), sequence)
}
val getAlias = fun(sequence: Int) {
    console.log(TAG, "getAlias", sequence, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:185")
    JPushInterface.getAlias(UTSAndroid.getAppContext(), sequence)
}
val setMobileNumber = fun(sequence: Int, mobileNumber: String) {
    console.log(TAG, "setMobileNumber", sequence, mobileNumber, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:190")
    JPushInterface.setMobileNumber(UTSAndroid.getAppContext(), sequence, mobileNumber)
}
val onResume = fun() {
    console.log(TAG, "onResume", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:195")
    JPushInterface.onResume(UTSAndroid.getAppContext())
}
val onPause = fun() {
    console.log(TAG, "onPause", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:200")
    JPushInterface.onPause(UTSAndroid.getAppContext())
}
val onFragmentResume = fun(fragmentName: String) {
    console.log(TAG, "onFragmentResume", fragmentName, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:205")
    JPushInterface.onFragmentResume(UTSAndroid.getAppContext(), fragmentName)
}
val onFragmentPause = fun(fragmentName: String) {
    console.log(TAG, "onFragmentPause", fragmentName, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:210")
    JPushInterface.onFragmentPause(UTSAndroid.getAppContext(), fragmentName)
}
val onKillProcess = fun() {
    console.log(TAG, "onKillProcess", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:215")
    JPushInterface.onKillProcess(UTSAndroid.getAppContext())
}
val requestPermission = fun() {
    console.log(TAG, "requestPermission", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:220")
    val activity = UTSAndroid.getUniActivity()
    if (activity != null) {
        JPushInterface.requestPermission(activity)
    } else {
        console.log(TAG, "requestPermission: getUniActivity() is null, fallback to getAppContext()", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:225")
        JPushInterface.requestPermission(UTSAndroid.getAppContext())
    }
}
val requestRequiredPermission = fun() {
    console.log(TAG, "requestRequiredPermission", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:235")
    val activity = UTSAndroid.getUniActivity()
    if (activity != null) {
        JPushInterface.requestRequiredPermission(activity)
    } else {
        console.log(TAG, "requestRequiredPermission: no Activity, skip (call when Activity available)", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:240")
    }
}
val isNotificationEnabled = fun(): Number {
    console.log(TAG, "isNotificationEnabled", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:245")
    return JPushInterface.isNotificationEnabled(UTSAndroid.getAppContext())
}
val goToAppNotificationSettings = fun() {
    console.log(TAG, "goToAppNotificationSettings", " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:250")
    JPushInterface.goToAppNotificationSettings(UTSAndroid.getAppContext())
}
val setBadgeNumber = fun(curNum: Int) {
    console.log(TAG, "setBadgeNumber", curNum, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:255")
    JPushInterface.setBadgeNumber(UTSAndroid.getAppContext(), curNum)
}
val setSmartPushEnable = fun(isEnable: Boolean) {
    console.log(TAG, "setSmartPushEnable", isEnable, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:260")
    JPushInterface.setSmartPushEnable(UTSAndroid.getAppContext(), isEnable)
}
val setGeofenceEnable = fun(isEnable: Boolean) {
    console.log(TAG, "setGeofenceEnable", isEnable, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:265")
    JPushInterface.setGeofenceEnable(UTSAndroid.getAppContext(), isEnable)
}
val setDataInsightsEnable = fun(isEnable: Boolean) {
    console.log(TAG, "setDataInsightsEnable", isEnable, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:270")
...
val setKeepLongConnInBackground = fun(keep: Boolean) {
    console.log(TAG, "setKeepLongConnInBackground", keep, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:283")
...
val requestSubscribeChannel = fun(channelIds: UTSArray<String>) {
    console.log(TAG, "requestSubscribeChannel", channelIds, " at uni_modules/jg-jpush-u/utssdk/app-android/index.uts:293")
...
open class PushMessageReceiver : JPushMessageReceiver, IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PushMessageReceiver", "uni_modules/jg-jpush-u/utssdk/app-android/PushMessageReceiver.uts", 25, 14)
    }
    constructor() : super() {
