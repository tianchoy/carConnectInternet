...
const __sfc__ = defineComponent({
    ...
    computed: {
        ...
        // 按钮的样式
        buttonStyle(): (type: any) => UTSJSONObject {
            return (type): UTSJSONObject => {
    ...
    methods: {
        ...
        // 输入框值发生变化
        onInput(e) {
            const { value = '' } = isTruthy(e.detail) ? e.detail : {};
            // 为空返回
            if (value === '')
                return;
...
//# sourceMappingURL=uv-number-box.vue.map