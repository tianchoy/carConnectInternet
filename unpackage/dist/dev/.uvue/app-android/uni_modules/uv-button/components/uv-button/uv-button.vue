...
const __sfc__ = defineComponent({
    ...
    computed: {
        ...
        baseColor(): UTSJSONObject {
            let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-button/components/uv-button/uv-button.vue", 250, 9), } as UTSJSONObject;
            if (this.color) {
        ...
        nvueTextStyle(): UTSJSONObject {
            let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-button/components/uv-button/uv-button.vue", 280, 9), } as UTSJSONObject;
            // 针对自定义了color颜色的情况，镂空状态下，就是用自定义的颜色
            if (this.type === "info") {
                style["color"] = "#323233";
            }
...
//# sourceMappingURL=uv-button.vue.map