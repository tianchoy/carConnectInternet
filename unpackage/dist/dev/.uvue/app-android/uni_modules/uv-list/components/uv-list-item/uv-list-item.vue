...
const __sfc__ = defineComponent({
    ...
    methods: {
        ...
        pageApi(api) {
            let callback = { __$originalPosition: new UTSSourceMapPosition("callback", "uni_modules/uv-list/components/uv-list-item/uv-list-item.vue", 327, 9),
                url: this.to,
                success: res => {
                    this.$emit('click', {
                        data: res
...
//# sourceMappingURL=uv-list-item.vue.map