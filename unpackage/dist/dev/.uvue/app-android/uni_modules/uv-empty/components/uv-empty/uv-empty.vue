...
const __sfc__ = defineComponent({
    ...
    computed: {
        // 组件样式
        emptyStyle() {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-empty/components/uv-empty/uv-empty.vue", 84, 11), } as UTSJSONObject;
        ...
        textStyle(): UTSJSONObject {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-empty/components/uv-empty/uv-empty.vue", 91, 11), } as UTSJSONObject;
...
//# sourceMappingURL=uv-empty.vue.map