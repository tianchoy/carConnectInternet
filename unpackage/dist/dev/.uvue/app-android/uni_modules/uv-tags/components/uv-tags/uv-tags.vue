...
const __sfc__ = defineComponent({
    ...
    computed: {
        style(): UTSJSONObject {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-tags/components/uv-tags/uv-tags.vue", 105, 11), } as UTSJSONObject;
            if (this.bgColor) {
        ...
        // nvue下，文本颜色无法继承父元素
        textColor(): UTSJSONObject {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-tags/components/uv-tags/uv-tags.vue", 119, 11), } as UTSJSONObject;
            if (this.color) {
                style["color"] = this.color;
            }
            return style;
        },
        imgStyle(): UTSJSONObject {
...
//# sourceMappingURL=uv-tags.vue.map