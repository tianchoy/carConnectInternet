...
function GenUniModulesUvRadioComponentsUvRadioGroupUvRadioGroupRender(this: InstanceType<typeof __sfc__>): any | null {
    const _ctx = this;
    const _cache = this.$.renderCache;
    return _cE("view", _uM({
        class: _nC(["uv-radio-group", _ctx.bemClass]),
        style: _nS([_ctx.$uv.addStyle(this.customStyle)])
    }), [
        renderSlot(_ctx.$slots, "default")
    ], 6 /* CLASS, STYLE */);
}
export type UvRadioGroupComponentPublicInstance = InstanceType<typeof __sfc__>;
const GenUniModulesUvRadioComponentsUvRadioGroupUvRadioGroupStyles = [_uM([["uv-radio-group", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["uv-radio-group--row", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["flexWrap", "wrap"]]))], ["uv-radio-group--column", _pS(_uM([["display", "flex"], ["flexDirection", "column"]]))]])];
//# sourceMappingURL=uv-radio-group.vue.map