...
const __sfc__ = defineComponent({
    ...
    computed: {
        ...
        iconWrapStyle(): UTSJSONObject {
            // radio的整体样式
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-radio/components/uv-radio/uv-radio.vue", 161, 11), } as UTSJSONObject;
        ...
        radioStyle() {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-radio/components/uv-radio/uv-radio.vue", 173, 11), } as UTSJSONObject;
...
//# sourceMappingURL=uv-radio.vue.map