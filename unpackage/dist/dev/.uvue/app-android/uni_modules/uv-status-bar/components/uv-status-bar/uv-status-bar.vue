...
const __sfc__ = defineComponent({
    ...
    computed: {
        style() {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-status-bar/components/uv-status-bar/uv-status-bar.vue", 31, 11), } as UTSJSONObject;
...
//# sourceMappingURL=uv-status-bar.vue.map