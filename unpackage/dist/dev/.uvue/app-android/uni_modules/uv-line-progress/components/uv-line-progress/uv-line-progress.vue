...
const __sfc__ = defineComponent({
    ...
    computed: {
        progressStyle(): UTSJSONObject {
            let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-line-progress/components/uv-line-progress/uv-line-progress.vue", 60, 9), } as UTSJSONObject;
...
//# sourceMappingURL=uv-line-progress.vue.map