...
const __sfc__ = defineComponent({
    ...
    computed: {
        ...
        // 组件的样式
        wrapperStyle() {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-input/components/uv-input/uv-input.vue", 170, 11), } as UTSJSONObject;
            // 禁用状态下，被背景色加上对应的样式
            if (this.disabled) {
        ...
        inputStyle(): UTSJSONObject {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-input/components/uv-input/uv-input.vue", 189, 11),
                color: this.color,
...
//# sourceMappingURL=uv-input.vue.map