...
const __sfc__ = defineComponent({
    ...
    computed: {
        // 为了解决支付宝不生效
        textStyle(): (index: any, index1: any) => UTSJSONObject {
            return (index, index1): UTSJSONObject => {
                const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-picker/components/uv-picker/uv-picker.vue", 109, 11), } as UTSJSONObject;
                style["display"] = 'block';
                if (this.color) {
...
//# sourceMappingURL=uv-picker.vue.map