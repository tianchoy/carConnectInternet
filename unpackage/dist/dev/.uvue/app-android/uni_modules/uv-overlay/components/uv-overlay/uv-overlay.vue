...
const __sfc__ = defineComponent({
    ...
    computed: {
        overlayStyle() {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-overlay/components/uv-overlay/uv-overlay.vue", 49, 11),
                position: 'fixed',
                top: 0,
                left: 0,
                right: 0,
...
//# sourceMappingURL=uv-overlay.vue.map