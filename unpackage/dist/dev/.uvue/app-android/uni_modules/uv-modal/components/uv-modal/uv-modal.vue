...
const __sfc__ = defineComponent({
    ...
    computed: {
        nvueStyle(): UTSJSONObject {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-modal/components/uv-modal/uv-modal.vue", 136, 11), } as UTSJSONObject;
            // 避免nvue中不能换行的问题
            return style;
        }
    },
...
//# sourceMappingURL=uv-modal.vue.map