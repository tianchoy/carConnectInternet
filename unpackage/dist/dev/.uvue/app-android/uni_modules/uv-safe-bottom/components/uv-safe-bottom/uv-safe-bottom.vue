...
const __sfc__ = defineComponent({
    ...
    computed: {
        style() {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-safe-bottom/components/uv-safe-bottom/uv-safe-bottom.vue", 34, 11), } as UTSJSONObject;
...
//# sourceMappingURL=uv-safe-bottom.vue.map