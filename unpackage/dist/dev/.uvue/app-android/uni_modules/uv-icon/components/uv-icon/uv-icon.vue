...
const __sfc__ = defineComponent({
    ...
    computed: {
        ...
        iconStyle(): UTSJSONObject {
            let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-icon/components/uv-icon/uv-icon.vue", 109, 9), } as UTSJSONObject;
            style = {
        ...
        imgStyle(): UTSJSONObject {
            let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-icon/components/uv-icon/uv-icon.vue", 127, 9), } as UTSJSONObject;
...
//# sourceMappingURL=uv-icon.vue.map