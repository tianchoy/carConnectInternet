...
function GenUniModulesUvCheckboxComponentsUvCheckboxGroupUvCheckboxGroupRender(this: InstanceType<typeof __sfc__>): any | null {
    const _ctx = this;
    const _cache = this.$.renderCache;
    return _cE("view", _uM({
        class: _nC(["uv-checkbox-group", _ctx.bemClass]),
        style: _nS([_ctx.$uv.addStyle(this.customStyle)])
    }), [
        renderSlot(_ctx.$slots, "default")
    ], 6 /* CLASS, STYLE */);
}
export type UvCheckboxGroupComponentPublicInstance = InstanceType<typeof __sfc__>;
const GenUniModulesUvCheckboxComponentsUvCheckboxGroupUvCheckboxGroupStyles = [_uM([["uv-checkbox-group", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["uv-checkbox-group--row", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["flexWrap", "wrap"]]))], ["uv-checkbox-group--column", _pS(_uM([["display", "flex"], ["flexDirection", "column"]]))]])];
//# sourceMappingURL=uv-checkbox-group.vue.map