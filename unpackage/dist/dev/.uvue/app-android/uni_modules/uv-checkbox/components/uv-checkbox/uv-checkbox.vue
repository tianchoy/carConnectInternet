...
const __sfc__ = defineComponent({
    ...
    computed: {
        ...
        iconWrapStyle(): UTSJSONObject {
            // checkbox的整体样式
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-checkbox/components/uv-checkbox/uv-checkbox.vue", 162, 11), } as UTSJSONObject;
        ...
        checkboxStyle() {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-checkbox/components/uv-checkbox/uv-checkbox.vue", 174, 11), } as UTSJSONObject;
