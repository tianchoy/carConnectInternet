...
const __sfc__ = defineComponent({
    ...
    methods: {
        ...
        // 对部分表单字段进行校验
        async validateField(value, callback, event = null): Promise<void> {
        ...
        // 校验全部数据
        validate(callback): Promise<unknown> {
...
function GenUniModulesUvFormComponentsUvFormUvFormRender(this: InstanceType<typeof __sfc__>): any | null {
    const _ctx = this;
    const _cache = this.$.renderCache;
    return _cE("view", _uM({ class: "uv-form" }), [
        renderSlot(_ctx.$slots, "default")
    ]);
}
export type UvFormComponentPublicInstance = InstanceType<typeof __sfc__>;
const GenUniModulesUvFormComponentsUvFormUvFormStyles = [];
//# sourceMappingURL=uv-form.vue.map