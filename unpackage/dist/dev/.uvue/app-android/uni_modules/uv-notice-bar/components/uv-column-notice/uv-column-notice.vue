...
const __sfc__ = defineComponent({
    ...
    computed: {
        ...
        textStyle(): UTSJSONObject {
            let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-notice-bar/components/uv-column-notice/uv-column-notice.vue", 96, 9), } as UTSJSONObject;
        ...
        swiperStyle(): UTSJSONObject {
            const style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-notice-bar/components/uv-column-notice/uv-column-notice.vue", 108, 11), } as UTSJSONObject;
            return style;
        }
    },
    data() {
...
//# sourceMappingURL=uv-column-notice.vue.map