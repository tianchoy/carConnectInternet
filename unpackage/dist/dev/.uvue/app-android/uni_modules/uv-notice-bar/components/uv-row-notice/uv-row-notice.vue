...
const __sfc__ = defineComponent({
    ...
    computed: {
        ...
        textStyle(): UTSJSONObject {
            let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-notice-bar/components/uv-row-notice/uv-row-notice.vue", 128, 9), } as UTSJSONObject;
            style["color"] = this.color;
            style["fontSize"] = this.$uv.addUnit(this.fontSize);
            return style;
        },
        animationStyle(): UTSJSONObject {
            let style = { __$originalPosition: new UTSSourceMapPosition("style", "uni_modules/uv-notice-bar/components/uv-row-notice/uv-row-notice.vue", 134, 9), } as UTSJSONObject;
...
//# sourceMappingURL=uv-row-notice.vue.map