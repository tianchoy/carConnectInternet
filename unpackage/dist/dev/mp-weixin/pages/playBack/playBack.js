  ...
  setup(__props) {
    ...
    function resolveRouteDateTime(dateStr) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/playBack/playBack.uvue:204", "解析回放时间失败:", error);
        return null;
      }
    }
    ...
    const loadTrackPos = () => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (requestId != replaySessionId)
            return Promise.resolve(null);
          common_vendor.index.__f__("error", "at pages/playBack/playBack.uvue:684", "加载轨迹失败:", error);
    ...
    common_vendor.onLoad((option) => {
      ...
      common_vendor.index.__f__("log", "at pages/playBack/playBack.uvue:813", sTime.value, eTime.value);
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = {
        ...
        j: common_vendor.t(getPlaybackDate(startTime.value)),
        k: common_vendor.t(getPlaybackClock(startTime.value)),
        ...
        o: common_vendor.t(getPlaybackDate(endTime.value)),
        p: common_vendor.t(getPlaybackClock(endTime.value)),
        ...
        t: common_vendor.o(togglePlayback, "0c"),
        v: common_vendor.p({
          type: "primary",
          size: "small",
          text: isPlaying.value ? "暂停" : "播放"
        }),
        w: common_vendor.o(setPlaybackSpeedFromValue, "a6"),
        ...
        z: common_vendor.t(playbackSpeed.value),
        A: common_vendor.t(currentTime.value),
        B: common_vendor.t(currentSpeed.value),
        C: common_vendor.t((totalDistance.value / 1e3).toFixed(1)),
        D: common_vendor.o(onConfirm, "f0"),
        E: common_vendor.o(onCancel, "c0"),
        F: common_vendor.p({
          ["confirm-btn"]: "确认",
          ["cancel-btn"]: "取消",
