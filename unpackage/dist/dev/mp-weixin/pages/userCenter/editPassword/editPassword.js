    ...
    common_vendor.onLoad((options) => {
      if (options.userInfo) {
        try {
          ...
          common_vendor.index.__f__("log", "at pages/userCenter/editPassword/editPassword.uvue:52", parsedInfo);
          userInfo.value = {
            id: parsedInfo.getString("userId") || "",
            mobile: parsedInfo.getString("mobile") || ""
          };
          common_vendor.index.__f__("log", "at pages/userCenter/editPassword/editPassword.uvue:57", "用户信息:", userInfo.value);
        } catch (e) {
          common_vendor.index.__f__("error", "at pages/userCenter/editPassword/editPassword.uvue:59", "解析用户信息失败:", e);
        }
      }
    });
