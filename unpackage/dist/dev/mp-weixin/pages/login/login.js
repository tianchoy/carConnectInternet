  ...
  setup(__props) {
    ...
    const handleGetPhoneNumber = (e = null) => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (!res || !res.data) {
            common_vendor.index.showToast({
              title: (res === null || res === void 0 ? null : res.msg) || "登录失败",
              icon: "none"
            });
            return Promise.resolve(null);
          }
      ...
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (res && res.data && res.data.token) {
            ...
            common_vendor.index.showToast({
              title: (res === null || res === void 0 ? null : res.msg) || "登录失败，请重试",
              icon: "error"
            });
          }
        } catch (error) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = common_vendor.e({
        ...
        g: common_vendor.o(filterNonLatin, "52"),
        ...
        k: common_vendor.o(toggleRememberPassword, "be"),
        l: common_vendor.p({
          checked: rememberPassword.value,
          label: "记住密码",
          class: "data-v-27a30816"
        }),
        m: common_vendor.o(submit, "ab"),
        n: common_vendor.p({
          type: "primary",
        ...
        s: common_vendor.o(loginBt, "70")
      } : {}, {
        t: docState.value
      }, docState.value ? {
        v: common_vendor.o(handleGetPhoneNumber, "02")
      } : {}), {
        w: common_vendor.o(gotoAgreement, "b6"),
        x: common_vendor.o(gotoPrivacy, "cf"),
        y: common_vendor.o(isDocState, "a9"),
        z: common_vendor.p({
          checked: docState.value,
          class: "data-v-27a30816"
        }),
        A: common_vendor.o(gotoIndex, "b0"),
        B: common_vendor.t(pswLogin.value ? "个人用户登录" : "企业用户登录"),
        C: common_vendor.o(isPswLogin, "82"),
