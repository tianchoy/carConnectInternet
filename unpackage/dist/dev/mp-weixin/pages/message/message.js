...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    common_vendor.onLoad(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:75", "页面加载 - 初始化数据");
      loadMsgList(true);
    });
    common_vendor.onShow(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:81", "页面显示 - 启动自动刷新");
      isPageActive.value = true;
      startNewMessageCheck();
      checkNewMessages();
    });
    common_vendor.onHide(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:90", "页面隐藏 - 停止自动刷新");
      isPageActive.value = false;
      stopNewMessageCheck();
    });
    common_vendor.onUnload(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:97", "页面卸载 - 清理资源");
      isPageActive.value = false;
      stopNewMessageCheck();
    });
    common_vendor.onActivated(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:103", "页面激活 - 启动自动刷新");
      isPageActive.value = true;
      startNewMessageCheck();
      checkNewMessages();
    });
    common_vendor.onDeactivated(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:111", "页面停用 - 停止自动刷新");
      isPageActive.value = false;
      stopNewMessageCheck();
    });
    const onRefresherRefresh = () => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:118", "下拉刷新触发");
    ...
    const onScrollToLower = () => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:129", "滚动到底部 - 当前页:", currPage.value, "总页数:", totalPage.value);
    ...
    const startNewMessageCheck = () => {
      ...
      common_vendor.index.__f__("log", "at pages/message/message.uvue:141", "启动定时消息检查");
      checkTimer = setInterval(() => {
        if (isPageActive.value) {
          common_vendor.index.__f__("log", "at pages/message/message.uvue:145", "定时检查新消息...");
          checkNewMessages();
        }
      }, 1e4);
    };
    const stopNewMessageCheck = () => {
      if (checkTimer) {
        common_vendor.index.__f__("log", "at pages/message/message.uvue:154", "停止定时消息检查");
    ...
    const checkNewMessages = () => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c;
        if (!isPageActive.value) {
          common_vendor.index.__f__("log", "at pages/message/message.uvue:164", "页面不活跃，跳过新消息检查");
          return Promise.resolve(null);
        }
        if (isLoading.value) {
          common_vendor.index.__f__("log", "at pages/message/message.uvue:170", "正在加载中，跳过新消息检查");
          return Promise.resolve(null);
        }
        try {
          common_vendor.index.__f__("log", "at pages/message/message.uvue:175", "开始检查新消息...");
    ...
    const loadNewMessages = () => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:223", "加载新消息");
      loadMsgList(true).then(() => {
        hasNewMessages.value = false;
        newMessageCount.value = 0;
        lastUpdateTime.value = (/* @__PURE__ */ new Date()).getTime();
        common_vendor.index.__f__("log", "at pages/message/message.uvue:228", "新消息加载完成");
      });
    };
    const loadMsgList = (isInit = false) => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          common_vendor.index.__f__("log", "at pages/message/message.uvue:248", "请求数据 - 页码:", currPage.value);
          const res = yield api_request.getUserMsgList(new UTSJSONObject({
            page: currPage.value,
          ...
          if (res.code == 0 && res.msg == "success") {
            ...
            common_vendor.index.__f__("log", "at pages/message/message.uvue:260", "第", currPage.value, "页接口返回:", data);
            common_vendor.index.__f__("log", "at pages/message/message.uvue:261", "第", currPage.value, "页列表长度:", (_a = data.list) === null || _a === void 0 ? null : _a.length);
            if (isInit) {
              ...
              common_vendor.index.__f__("log", "at pages/message/message.uvue:271", "即将添加的新数据长度:", newData.length);
            ...
            loadStatus.value = "loadmore";
            common_vendor.index.__f__("error", "at pages/message/message.uvue:296", "接口返回错误:", res.msg);
          }
        } catch (error) {
          loadStatus.value = "loadmore";
          common_vendor.index.__f__("error", "at pages/message/message.uvue:300", "请求异常:", error);
        } finally {
    ...
    const loadMore = () => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:308", "准备加载更多 - 当前页:", currPage.value, "总页数:", totalPage.value);
      if (currPage.value < totalPage.value) {
        currPage.value++;
        loadMsgList();
      } else {
      ...
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        if (item.status == 1) {
          try {
            ...
            common_vendor.index.__f__("error", "at pages/message/message.uvue:334", "更新状态失败:", error);
          }
        }
      });
    };
