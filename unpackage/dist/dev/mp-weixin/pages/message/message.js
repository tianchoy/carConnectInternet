...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    common_vendor.onLoad(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:76", "页面加载 - 初始化数据");
      loadMsgList(true);
    });
    common_vendor.onShow(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:82", "页面显示 - 启动自动刷新");
      isPageActive.value = true;
      startNewMessageCheck();
      checkNewMessages();
    });
    common_vendor.onHide(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:91", "页面隐藏 - 停止自动刷新");
      isPageActive.value = false;
      stopNewMessageCheck();
    });
    common_vendor.onUnload(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:98", "页面卸载 - 清理资源");
      isPageActive.value = false;
      stopNewMessageCheck();
    });
    common_vendor.onActivated(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:104", "页面激活 - 启动自动刷新");
      isPageActive.value = true;
      startNewMessageCheck();
      checkNewMessages();
    });
    common_vendor.onDeactivated(() => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:112", "页面停用 - 停止自动刷新");
      isPageActive.value = false;
      stopNewMessageCheck();
    });
    const onRefresherRefresh = () => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:119", "下拉刷新触发");
    ...
    const onScrollToLower = () => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:130", "滚动到底部 - 当前页:", currPage.value, "总页数:", totalPage.value);
    ...
    const startNewMessageCheck = () => {
      ...
      common_vendor.index.__f__("log", "at pages/message/message.uvue:142", "启动定时消息检查");
      checkTimer = setInterval(() => {
        if (isPageActive.value) {
          common_vendor.index.__f__("log", "at pages/message/message.uvue:146", "定时检查新消息...");
          checkNewMessages();
        }
      }, 1e4);
    };
    const stopNewMessageCheck = () => {
      if (checkTimer) {
        common_vendor.index.__f__("log", "at pages/message/message.uvue:155", "停止定时消息检查");
    ...
    const checkNewMessages = () => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c;
        if (!isPageActive.value) {
          common_vendor.index.__f__("log", "at pages/message/message.uvue:165", "页面不活跃，跳过新消息检查");
          return Promise.resolve(null);
        }
        if (isLoading.value) {
          common_vendor.index.__f__("log", "at pages/message/message.uvue:171", "正在加载中，跳过新消息检查");
          return Promise.resolve(null);
        }
        try {
          common_vendor.index.__f__("log", "at pages/message/message.uvue:176", "开始检查新消息...");
          ...
          if (res.code == 0 && res.msg == "success") {
            ...
            if (latestMessage && latestMessage.createTime) {
              ...
              if (messageTime > lastUpdateTime.value) {
                common_vendor.index.__f__("log", "at pages/message/message.uvue:189", "发现新消息，时间:", latestMessage.createTime);
                ...
                if (countRes.code == 0) {
                  ...
                  common_vendor.index.__f__("log", "at pages/message/message.uvue:202", "新消息数量:", newMessageCount.value);
                }
              } else {
                common_vendor.index.__f__("log", "at pages/message/message.uvue:205", "没有发现新消息");
              }
            }
          }
        } catch (error) {
          common_vendor.index.__f__("error", "at pages/message/message.uvue:210", "检查新消息失败:", error);
        }
      });
    };
    const loadNewMessages = () => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:216", "加载新消息");
      loadMsgList(true).then(() => {
        hasNewMessages.value = false;
        newMessageCount.value = 0;
        lastUpdateTime.value = (/* @__PURE__ */ new Date()).getTime();
        common_vendor.index.__f__("log", "at pages/message/message.uvue:221", "新消息加载完成");
      });
    };
    const loadMsgList = (isInit = false) => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          common_vendor.index.__f__("log", "at pages/message/message.uvue:241", "请求数据 - 页码:", currPage.value);
          const res = yield api_request.getUserMsgList(new UTSJSONObject({
            page: currPage.value,
          ...
          if (res.code == 0 && res.msg == "success") {
            ...
            common_vendor.index.__f__("log", "at pages/message/message.uvue:253", "第", currPage.value, "页接口返回:", data);
            common_vendor.index.__f__("log", "at pages/message/message.uvue:254", "第", currPage.value, "页列表长度:", (_a = data.list) === null || _a === void 0 ? null : _a.length);
            if (isInit) {
              ...
              common_vendor.index.__f__("log", "at pages/message/message.uvue:264", "即将添加的新数据长度:", newData.length);
            ...
            loadStatus.value = "loadmore";
            common_vendor.index.__f__("error", "at pages/message/message.uvue:289", "接口返回错误:", res.msg);
          }
        } catch (error) {
          loadStatus.value = "loadmore";
          common_vendor.index.__f__("error", "at pages/message/message.uvue:293", "请求异常:", error);
        } finally {
    ...
    const loadMore = () => {
      common_vendor.index.__f__("log", "at pages/message/message.uvue:301", "准备加载更多 - 当前页:", currPage.value, "总页数:", totalPage.value);
      if (currPage.value < totalPage.value) {
        currPage.value++;
        loadMsgList();
      } else {
      ...
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        if (item.status == 1) {
          try {
            ...
            common_vendor.index.__f__("error", "at pages/message/message.uvue:327", "更新状态失败:", error);
          }
        }
      });
    };
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = common_vendor.e({
        ...
        h: refresherTriggered.value,
        i: common_vendor.o(onRefresherRefresh),
        j: common_vendor.o(onScrollToLower),
        k: common_vendor.sr(modal, "1993bd19-4", {
          "k": "modal"
        }),
        l: common_vendor.o(ReadIt),
        m: common_vendor.p({
