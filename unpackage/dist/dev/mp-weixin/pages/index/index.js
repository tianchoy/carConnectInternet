  ...
  setup(__props) {
    ...
    const saveSelectedDevice = (device) => {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/index/index.uvue:393", "保存选中设备成功:", deviceInfo);
      } catch (error) {
        common_vendor.index.__f__("error", "at pages/index/index.uvue:395", "保存选中设备失败:", error);
      }
    };
    ...
    const getSavedSelectedDevice = () => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/index.uvue:455", "获取保存设备失败:", error);
      }
      return null;
    };
    const clearSavedSelectedDevice = () => {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/index/index.uvue:464", "清除保存设备成功");
      } catch (error) {
        common_vendor.index.__f__("error", "at pages/index/index.uvue:466", "清除保存设备失败:", error);
      }
    };
    const saveSelectedDeviceIndex = (index) => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/index.uvue:475", "保存选中设备索引失败:", error);
      }
    };
    const getSavedSelectedDeviceIndex = () => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/index.uvue:488", "获取保存设备索引失败:", error);
      }
      return null;
    };
    const clearSavedSelectedDeviceIndex = () => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/index.uvue:498", "清除保存设备索引失败:", error);
      }
    };
    ...
    function getUserLocation() {
      common_vendor.index.getLocation(new common_vendor.UTSJSONObject({
        type: "gcj02",
        success: (res) => {
          common_vendor.index.__f__("log", "at pages/index/index.uvue:615", "用户当前位置:", res);
        ...
        fail: (err) => {
          common_vendor.index.__f__("error", "at pages/index/index.uvue:624", "获取用户当前位置失败:", err.errMsg, err);
        }
      }));
    }
      ...
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (res.code != 200 || detail == null) {
            common_vendor.index.__f__("error", "at pages/index/index.uvue:635", "加载设备详情失败:", res.msg);
            return Promise.resolve(null);
          }
          if (detail != null) {
          ...
          common_vendor.index.__f__("error", "at pages/index/index.uvue:657", "加载设备详情失败", error);
        }
      });
    };
      ...
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (requestId != trackRequestId)
            return Promise.resolve(null);
          if (res.code != 200) {
            common_vendor.index.__f__("error", "at pages/index/index.uvue:743", "加载轨迹失败:", res.msg);
            clearTripData();
            return Promise.resolve(null);
          }
          ...
          if (requestId != trackRequestId)
            return Promise.resolve(null);
          common_vendor.index.__f__("error", "at pages/index/index.uvue:756", "加载轨迹失败", error);
          clearTripData();
        }
      });
    };
      ...
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (res.code != 200 || positions == null || positions.length == 0) {
            common_vendor.index.__f__("warn", "at pages/index/index.uvue:780", "获取设备位置失败:", data.getString("deviceId", ""), res.code);
            positionState.value = "empty";
            return false;
          }
          ...
          if (!isValidCoordinate) {
            common_vendor.index.__f__("error", "at pages/index/index.uvue:795", "经纬度格式错误", position.getString("latitude", ""), position.getString("longitude", ""));
          ...
          try {
            ...
            common_vendor.index.__f__("error", "at pages/index/index.uvue:821", "刷新地图视图失败", mapError);
          }
          common_vendor.index.__f__("log", "at pages/index/index.uvue:823", "标记点更新完成:", data.getString("deviceId", ""), convertedCoord.lat, convertedCoord.lng);
          return true;
        } catch (error) {
          common_vendor.index.__f__("error", "at pages/index/index.uvue:826", "加载设备位置失败", error);
    ...
    const loadDeviceData = (device) => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        common_vendor.index.__f__("log", "at pages/index/index.uvue:838", "开始加载设备数据:", device);
        try {
          ...
          common_vendor.index.__f__("error", "at pages/index/index.uvue:851", "切换车辆失败", error);
          utils_toast.showAppToast({
            title: "切换失败，请重试",
            icon: "none"
          });
    ...
    const handlePickerConfirm = (e) => {
      ...
      if (selectedDevice.imei == currentCarImei.value && selectedDevice.deviceId == currentCarDeviceId.value) {
        common_vendor.index.__f__("log", "at pages/index/index.uvue:897", "选择的设备与当前设备相同，不重复加载");
        return null;
      }
    ...
    const loadDeviceList = () => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          common_vendor.index.__f__("log", "at pages/index/index.uvue:941", "加载车辆列表返回:", res.data);
          ...
          if (list != null && list.length > 0) {
            ...
            if (!selectedDevice && deviceList.value.length > 0) {
              ...
              common_vendor.index.__f__("log", "at pages/index/index.uvue:1018", "使用第一个设备作为默认:", selectedDevice === null || selectedDevice === void 0 ? null : selectedDevice.deviceName);
            }
            if (selectedDevice != null) {
          ...
          common_vendor.index.__f__("error", "at pages/index/index.uvue:1062", "加载车辆列表失败", error);
          utils_toast.showAppToast({
            title: "加载失败，请下拉重试",
            icon: "none"
          });
    ...
    const refreshLocation = () => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          common_vendor.index.__f__("error", "at pages/index/index.uvue:1099", "刷新位置失败", error);
          utils_toast.showAppToast({
            title: "刷新失败",
            icon: "none"
          });
      ...
      common_vendor.index.navigateTo({
        ...
        fail: (err) => {
          if (err.errMsg.indexOf("locked") < 0)
            common_vendor.index.__f__("error", "at pages/index/index.uvue:1143", "跳转轨迹详情失败:", err);
        }
      });
    };
    const toDeviceList = () => {
    ...
    const toAdd = () => {
      ...
      common_vendor.index.navigateTo({
        ...
        fail: (err) => {
          if (err.errMsg.indexOf("locked") < 0)
            common_vendor.index.__f__("error", "at pages/index/index.uvue:1171", "跳转添加设备失败:", err);
        }
      });
    };
    const toMsgCenter = () => {
    ...
    const contactCustomerService = () => {
      common_vendor.index.openCustomerServiceChat(new common_vendor.UTSJSONObject({
        ...
        success(res = null) {
          common_vendor.index.__f__("log", "at pages/index/index.uvue:1218", res);
        }
      }));
    };
    ...
    const toPay = (iccid, simMerchant) => {
      ...
      common_vendor.index.openEmbeddedMiniProgram(new common_vendor.UTSJSONObject({
        ...
        envVersion: "release",
        success(res = null) {
          common_vendor.index.__f__("log", "at pages/index/index.uvue:1248", "打开小程序成功", res);
        },
        fail(res = null) {
          common_vendor.index.__f__("log", "at pages/index/index.uvue:1251", "打开小程序失败", res);
    ...
    function unbindCurrentDevice() {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        common_vendor.index.__f__("log", "at pages/index/index.uvue:1285", "解绑设备结果:", result);
        if (result.code == 200) {
          utils_toast.showAppToast({
            title: "解绑成功",
            icon: "none"
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = common_vendor.e({
        ...
        I: common_vendor.o(toRecordDetail, "82"),
        ...
        N: common_vendor.o(toDeviceDetail, "ea"),
        ...
        Q: common_vendor.o(toFindCar, "54"),
        ...
        T: common_vendor.o(toFence, "d0"),
        U: common_assets._imports_6,
        V: common_vendor.o(toMsgCenter, "7a"),
        ...
        Z: common_vendor.o(contactCustomerService, "07"),
        aa: common_assets._imports_9,
        ab: common_vendor.o(logout, "a2"),
        ac: common_assets._imports_10,
        ad: common_vendor.o(unbindDevice, "f4"),
        ae: common_vendor.o(closePicker, "57"),
        af: common_vendor.o(handlePickerConfirm, "ea"),
