...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const selectList = (e = null) => {
      common_vendor.index.__f__("log", "at components/indexListMode/indexListMode.uvue:36", e.index);
    ...
    const getCustomLists = () => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        const res = yield api_request.getCustomList();
        common_vendor.index.__f__("log", "at components/indexListMode/indexListMode.uvue:49", "res", res);
      });
    };
    return (_ctx = null, _cache = null) => {
      const __returned__ = {
        ...
        f: common_vendor.o(getCustomLists),
        g: common_vendor.p({
          text: "test"
        }),
