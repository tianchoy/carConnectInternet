...
const _sfc_main = common_vendor.defineComponent({
  ...
  data() {
    return {
      ...
      backgroundStyle: new common_vendor.UTSJSONObject({}),
      // 用于fade模式的控制组件显示与否
      show: false,
  ...
  methods: {
    ...
    // 移除图片的背景色
    removeBgColor() {
      this.backgroundStyle = new common_vendor.UTSJSONObject({
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return common_vendor.e({
    ...
    c: _ctx.src,
    d: _ctx.mode,
    e: common_vendor.o((...args) => $options.onErrorHandler && $options.onErrorHandler(...args), "1e"),
    f: common_vendor.o((...args) => $options.onLoadHandler && $options.onLoadHandler(...args), "98"),
    ...
    x: common_vendor.o((...args) => $options.onClick && $options.onClick(...args), "4a"),
