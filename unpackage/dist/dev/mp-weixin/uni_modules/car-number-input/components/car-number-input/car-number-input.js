  ...
  return common_vendor.e({
    a: common_vendor.f($data.inputList, (item, index, i0) => {
      return common_vendor.e({
        ...
        b: $data.maxNum - 1 == index
      }, $data.maxNum - 1 == index ? {
        c: $data.xnyImgBase64
      } : {}, {
        d: common_vendor.t(item),
        e: common_vendor.n($data.curInput == index ? "sel-item" : ""),
        f: common_vendor.n($data.maxNum - 1 == index ? "last-item" : ""),
        g: index,
        h: common_vendor.o(($event) => $options.plateInput(index), index)
      });
    }),
    b: $data.showKeyPop1
  }, $data.showKeyPop1 ? {
