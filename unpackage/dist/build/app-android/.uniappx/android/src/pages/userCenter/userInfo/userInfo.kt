        ...
        var setup: (__props: GenPagesUserCenterUserInfoUserInfo) -> Any? = fun(__props): Any? {
            ...
            onLoad(fun(options){
                if (options["userInfo"] != null) {
                    try {
                        val parsedInfo = JSON.parse(decodeURIComponent(options["userInfo"] as String) as String) as UTSJSONObject
