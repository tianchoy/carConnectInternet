...
function GenUniModulesUvPopupComponentsUvPopupUvPopupRender(this: ({ $: ComponentInternalInstance; $data: { ani: never[]; showPopup: boolean; showTrans: boolean; popupWidth: number; popupHeight: number; config: { top: string; bottom: string; ... 5 more ...; share: string; }; ... 4 more ...; direction: string; }; ... 12 more ...; $watch<T extends string | ((...args: any) => any)>(source: T, cb: T extends (...args: any) => infer R ? (args_0: R, args_1: R, args_2: OnCleanup) => any : (args_0: any, args_1: any, args_2: OnCleanup) => any, options?: WatchOptions<...> | undefined): WatchStopHandle; } & ... 8 more ... & {}) | ({ $: ComponentInternalInstance; $data: { ani: never[]; showPopup: boolean; showTrans: boolean; popupWidth: number; popupHeight: number; config: { top: string; bottom: string; ... 5 more ...; share: string; }; ... 4 more ...; direction: string; }; ... 12 more ...; $watch<T extends string | ((...args: any) => any)>(source: T, cb: T extends (...args: any) => infer R ? (args_0: R, args_1: R, args_2: OnCleanup) => any : (args_0: any, args_1: any, args_2: OnCleanup) => any, options?: WatchOptions<...> | undefined): WatchStopHandle; } & ... 8 more ... & {})): any | null {
    const _ctx = this;
