...
const normalized = computed(() : number => {
...
return (): any | null => {
  ...
  return _cE("view", _uM({
    ...
    _cE("view", _uM({ class: "i-row" }), [
      _cE("view", _uM({
        class: "i-btn",
        onClick: withModifiers(() => {step(-15)}, ["stop"])
      }), [
        _cE("text", _uM({ class: "i-btn-text" }), "减少")
      ], 8 /* PROPS */, ["onClick"]),
      _cE("view", _uM({
        class: "i-btn",
        onClick: withModifiers(() => {step(15)}, ["stop"])
      }), [
        _cE("text", _uM({ class: "i-btn-text" }), "增加")
      ], 8 /* PROPS */, ["onClick"])
    ])
  ])
}
...
const GenUniModulesIUiXComponentsILineProgressILineProgressStyles = [_uM([["i-card", _pS(_uM([["paddingTop", 14], ["paddingRight", 14], ["paddingBottom", 14], ["paddingLeft", 14], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8], ["backgroundColor", "#ffffff"]]))], ["i-title", _pS(_uM([["color", "#303133"], ["fontSize", 15], ["fontWeight", 600], ["lineHeight", "22px"]]))], ["i-muted", _pS(_uM([["marginTop", 4], ["color", "#909399"], ["fontSize", 12], ["lineHeight", "18px"]]))], ["i-row", _pS(_uM([["flexDirection", "row"], ["alignItems", "center"], ["flexWrap", "wrap"]]))], ["i-btn", _pS(_uM([["minHeight", 34], ["marginTop", 10], ["marginRight", 8], ["paddingTop", 0], ["paddingRight", 12], ["paddingBottom", 0], ["paddingLeft", 12], ["borderTopLeftRadius", 6], ["borderTopRightRadius", 6], ["borderBottomRightRadius", 6], ["borderBottomLeftRadius", 6], ["backgroundColor", "#ecf5ff"], ["alignItems", "center"], ["justifyContent", "center"]]))], ["i-btn--plain", _pS(_uM([["backgroundColor", "#f5f7fa"]]))], ["i-btn--danger", _pS(_uM([["backgroundColor", "#fef0f0"]]))], ["i-btn-text", _pS(_uM([["color", "#2979ff"], ["fontSize", 13], ["lineHeight", "18px"]]))], ["i-danger", _pS(_uM([["color", "#f56c6c"]]))], ["i-head", _pS(_uM([["justifyContent", "space-between"]]))], ["i-track", _pS(_uM([["marginTop", 12], ["borderTopLeftRadius", 999], ["borderTopRightRadius", 999], ["borderBottomRightRadius", 999], ["borderBottomLeftRadius", 999], ["overflow", "hidden"]]))], ["i-fill", _pS(_uM([["height", "100%"], ["borderTopLeftRadius", 999], ["borderTopRightRadius", 999], ["borderBottomRightRadius", 999], ["borderBottomLeftRadius", 999]]))]])]
