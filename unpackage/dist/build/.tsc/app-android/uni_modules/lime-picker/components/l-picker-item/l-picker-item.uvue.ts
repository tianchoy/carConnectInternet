...
const GenUniModulesLimePickerComponentsLPickerItemLPickerItemStyles = [_uM([["l-picker-item__group", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"]]))], ["l-picker-item__group-item", _pS(_uM([["height", 50], ["lineHeight", "50px"], ["textAlign", "center"], ["transitionDuration", "100ms"], ["transitionProperty", "fontWeight,color"], ["transitionTimingFunction", "linear"], ["fontWeight", "400"], ["color", "rgba(0,0,0,0.88)"], ["fontSize", 16], ["whiteSpace", "nowrap"]]))], ["l-picker-item__group-item--active", _pS(_uM([["color", "rgba(0,0,0,0.88)"], ["fontWeight", "700"]]))], ["l-picker-item__indicator", _pS(_uM([["left", "0rpx"], ["right", "0rpx"], ["width", "auto"], ["height", 50], ["pointerEvents", "none"], ["backgroundColor", "rgba(0,0,0,0.02)"]]))], ["@TRANSITION", _uM([["l-picker-item__group-item", _uM([["duration", "100ms"], ["property", "fontWeight,color"], ["timingFunction", "linear"]])]])]])]
