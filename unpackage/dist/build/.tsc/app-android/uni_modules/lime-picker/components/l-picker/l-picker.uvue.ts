...
const __sfc__ = defineComponent({
  ...
  props: {
    ...
    maskColors: { type: Array as PropType<string[]>, required: false },
...
__ins.emit(event, ...do_not_transform_spread)
	...
	const stopPickerValue = watch(pickerValue, () => {
		if (arrayEqual(pickerValue.value, curValueArray.value)) return
      ...
      ? _cE("view", _uM({
          ...
          _ctx.cancelBtn != null
            ? _cE("text", _uM({
                ...
                style: _nS([_ctx.cancelStyle??_uM<string, any | null>({})]),
                onClick: onCancel
              }), _tD(_ctx.cancelBtn), 5 /* TEXT, STYLE */)
            : _cC("v-if", true),
          _cE("text", _uM({
            class: "l-picker__title",
            style: _nS([_ctx.titleStyle??_uM<string, any | null>({})])
          }), _tD(_ctx.title), 5 /* TEXT, STYLE */),
          _ctx.confirmBtn != null
            ? _cE("text", _uM({
                key: 1,
                class: "l-picker__confirm",
                style: _nS([_ctx.confirmStyle??_uM<string, any | null>({})]),
                onClick: onConfirm
...
const GenUniModulesLimePickerComponentsLPickerLPickerStyles = [_uM([["l-picker", _pS(_uM([["position", "relative"], ["backgroundColor", "var(--l-picker-bg-color, #fff)"], ["borderTopLeftRadius", "var(--l-picker-border-radius, 12px)"], ["borderTopRightRadius", "var(--l-picker-border-radius, 12px)"]]))], ["l-picker__toolbar", _pS(_uM([["display", "flex"], ["alignItems", "center"], ["justifyContent", "space-between"], ["height", "var(--l-picker-toolbar-height, 58px)"], ["flexDirection", "row"], ["position", "relative"]]))], ["l-picker__title", _pS(_uM([["position", "absolute"], ["left", "50%"], ["top", "50%"], ["transform", "translateX(-50%) translateY(-50%)"], ["textAlign", "center"], ["overflow", "hidden"], ["whiteSpace", "nowrap"], ["textOverflow", "ellipsis"], ["color", "var(--l-picker-title-color, #000000E0)"], ["lineHeight", "var(--l-picker-title-line-height, 26px)"], ["fontWeight", "var(--l-picker-title-font-weight, 700)"], ["fontSize", "var(--l-picker-title-font-size, 18px)"]]))], ["l-picker__cancel", _pS(_uM([["whiteSpace", "nowrap"], ["fontSize", "var(--l-picker-button-font-size, 16px)"], ["lineHeight", "var(--l-picker-toolbar-height, 58px)"], ["height", "100%"], ["paddingTop", 0], ["paddingRight", 16], ["paddingBottom", 0], ["paddingLeft", 16], ["marginRight", "auto"], ["color", "var(--l-picker-cancel-color, #000000A6)"]]))], ["l-picker__confirm", _pS(_uM([["whiteSpace", "nowrap"], ["fontSize", "var(--l-picker-button-font-size, 16px)"], ["lineHeight", "var(--l-picker-toolbar-height, 58px)"], ["height", "100%"], ["paddingTop", 0], ["paddingRight", 16], ["paddingBottom", 0], ["paddingLeft", 16], ["marginLeft", "auto"], ["color", "var(--l-picker-confirm-color, #3283ff)"]]))], ["l-picker__main", _pS(_uM([["position", "relative"], ["display", "flex"], ["height", "var(--l-picker-group-height, 200px)"], ["flexDirection", "row"], ["zIndex", 2], ["paddingTop", 0], ["paddingRight", 8], ["paddingBottom", 0], ["paddingLeft", 8]]))], ["l-picker__empty", _pS(_uM([["pointerEvents", "none"], ["justifyContent", "center"], ["alignItems", "center"], ["display", "flex"], ["position", "absolute"], ["top", 0], ["bottom", 0], ["left", 0], ["right", 0], ["zIndex", 3]]))], ["l-picker__loading", _pS(_uM([["zIndex", 3], ["backgroundColor", "var(--l-picker-loading-mask-color, rgba(255, 255, 255, 0.9))"], ["justifyContent", "center"], ["alignItems", "center"], ["display", "flex"], ["position", "absolute"], ["top", 0], ["bottom", 0], ["left", 0], ["right", 0]]))], ["l-picker__indicator", _pS(_uM([["position", "absolute"], ["backgroundColor", "var(--l-picker-indicator-bg-color, #0000000A)"], ["top", "50%"], ["left", "var(--l-picker-indicator-margin, 10px)"], ["right", "var(--l-picker-indicator-margin, 10px)"], ["height", "var(--l-picker-item-height, 50px)"], ["transform", "translateY(-50%)"], ["zIndex", -1], ["borderTopLeftRadius", "var(--l-picker-indicator-border-radius, 6px)"], ["borderTopRightRadius", "var(--l-picker-indicator-border-radius, 6px)"], ["borderBottomRightRadius", "var(--l-picker-indicator-border-radius, 6px)"], ["borderBottomLeftRadius", "var(--l-picker-indicator-border-radius, 6px)"]]))]])]
