...
const _component_uv_picker = resolveEasyComponent("uv-picker",_easycom_uv_picker)
  ...
  return _cE(Fragment, null, [
    _cE("cover-view", _uM({ class: "tools-box" }), [
      isTrue(_ctx.showTime)
        ? _cE("cover-view", _uM({
            ...
            _cE("cover-view", _uM({ class: "times" }), [
              _cE("cover-view", null, _tD(_ctx.currentTime), 1 /* TEXT */),
              isTrue(!_ctx.showPickerTime)
                ? _cE("cover-view", _uM({ key: 0 }), "刷新一次位置")
                : _cC("v-if", true)
            ]),
            isTrue(_ctx.showPickerTime)
              ? _cE("image", _uM({
      ...
      _cE("cover-view", _uM({ class: "car-box" }), [
        isTrue(_ctx.showCar)
          ? _cE("cover-view", _uM({
              key: 0,
              class: "selectCar",
              ...
              _cE("cover-view", _uM({ class: "plateNo" }), _tD(_ctx.currentCar), 1 /* TEXT */)
            ], 8 /* PROPS */, ["onClick"])
          : _cC("v-if", true),
        _cE("cover-view", _uM({
          class: _nC(["car-state", _ctx.carStatus == 'online' ? 'success' : 'error'])
        }), [
          _cE("cover-view", _uM({ class: "state" }), _tD(_ctx.carStatus == 'online' ? '在线' : '离线'), 1 /* TEXT */)
        ], 2 /* CLASS */)
      ])
    ]),
