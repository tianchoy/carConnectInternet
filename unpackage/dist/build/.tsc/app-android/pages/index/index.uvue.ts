...
const batteryPercent = computed<number>(() : number => {
    ...
    _cE("scroll-view", _uM({
      ...
      _cE("view", _uM({ class: "page-bg" }), [
        _cE("view", _uM({
          ...
          isTrue(hasDevice.value && batteryPercent.value > 0)
            ? _cE("view", _uM({
                key: 0,
                class: "device-info"
              }), [
                _cE("view", _uM({ class: "batteryPercent-info" }), [
                  _cE("text", _uM({ class: "battery-label" }), "电量"),
                  _cE("view", _uM({ class: "battery-progress" }), [
                  ...
                  _cE("text", _uM({ class: "battery-value" }), _tD(batteryPercent.value) + "%", 1 /* TEXT */)
                ]),
          ...
          _cE("view", _uM({ class: "service" }), [
            ...
            _cE("view", _uM({ class: "service-content" }), [
              _cE("view", _uM({
                ...
                _cE("view", _uM({ class: "message-icon-wrap" }), [
                  _cE("image", _uM({
                    src: _imports_5,
                    mode: "aspectFit",
                    class: "icon-image"
                  ...
                  unreadMessageCount.value > 0
                    ? _cE("text", _uM({
                      ...
                      }), _tD(unreadMessageBadgeText.value), 1 /* TEXT */)
                    : _cC("v-if", true)
                ]),
