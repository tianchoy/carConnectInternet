        ...
        var setup: (__props: GenPagesIndexIndex) -> Any? = fun(__props): Any? {
            ...
            val unreadMessageBadgeText = computed<String>(fun(): String {
                return if (unreadMessageCount.value > 99) {
                    ...
                    unreadMessageCount.value.toString(10)
                }
            }
            )
            ...
            val batteryPercent = computed<Number>(fun(): Number {
                val percent = safeDeviceDetail.value.deviceStatus.batteryPercent
            ...
            val saveSelectedDevice = fun(device: Device){
                try {
                    val deviceInfo: UTSJSONObject = _uO("name" to if (device.deviceName != "") {
                        device.deviceName
                    } else {
                        if (device.name != "") {
                            device.name
            ...
            val decodeSavedDevice = fun(raw: Any): SavedDevice? {
                ...
                if (UTSAndroid.`typeof`(raw) == "string") {
                    try {
                        data = JSON.parse(raw as String) as UTSJSONObject
                    } catch (error: Throwable) {
                        return null
                    }
                } else {
            ...
            val loadUnreadMessageCount = ::gen_loadUnreadMessageCount_fn
            ...
            fun gen_performLogout_fn(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
            ...
            val performLogout = ::gen_performLogout_fn
            val logout__1 = fun(): Unit {
                if (!isLogin()) {
                    return
                }
                showAppModal(AppModalOptions(title = "退出登录", content = "确定退出登录吗？", success = fun(res: AppModalSuccess): Unit {
                    if (res.confirm) {
                        performLogout()
                    }
                }
                    ...
                    _cE("scroll-view", _uM("class" to "container", "scroll-y" to "true", "show-scrollbar" to false), _uA(
                        _cE("view", _uM("class" to "page-bg"), _uA(
                            _cE("view", _uM("class" to "top", "style" to _nS(_uM("paddingTop" to (statusBarHeight.value + 10 + "px")))), _uA(
                                ...
                                if (isTrue(hasDevice.value && batteryPercent.value > 0)) {
                                    _cE("view", _uM("key" to 0, "class" to "device-info"), _uA(
                                        _cE("view", _uM("class" to "batteryPercent-info"), _uA(
                                            _cE("text", _uM("class" to "battery-label"), "电量"),
                                            _cE("view", _uM("class" to "battery-progress"), _uA(
                                                _cV(_component_i_line_progress, _uM("percent" to batteryPercent.value, "show-text" to false, "active-color" to "#19be6b", "inactive-color" to "#ebeef5", "height" to 8), null, 8, _uA(
                                                    "percent"
                                                ))
                                            )),
                                            _cE("text", _uM("class" to "battery-value"), _tD(batteryPercent.value) + "%", 1)
                                        )),
                                        if (safeDeviceDetail.value.deviceStatus.voltage > 0) {
                                            _cE("view", _uM("key" to 0, "class" to "info"), " 电压: " + _tD(safeDeviceDetail.value.deviceStatus.voltage) + "V ", 1)
                                        } else {
                                            _cC("v-if", true)
                                        }
                                    ))
                            ...
                            _cE("view", _uM("class" to "content"), _uA(
                                ...
                                _cE("view", _uM("class" to "mile-record"), _uA(
                                    _cE("view", _uM("class" to "record-header"), _uA(
                                        ...
                                        _cE("view", _uM("class" to "record-desc-wrap", "onClick" to toRecordDetail), _uA(
                                            _cE("text", _uM("class" to "record-desc"), "更多轨迹")
                                        ))
                                    )),
                                ...
                                _cE("view", _uM("class" to "service"), _uA(
                                    ...
                                    _cE("view", _uM("class" to "service-content"), _uA(
                                        _cE("view", _uM("class" to "service-item", "onClick" to toMsgCenter), _uA(
                                            _cE("view", _uM("class" to "message-icon-wrap"), _uA(
                                                _cE("image", _uM("src" to default__4, "mode" to "aspectFit", "class" to "icon-image")),
                                                if (unreadMessageCount.value > 0) {
                                                    _cE("text", _uM("key" to 0, "class" to "message-unread-badge"), _tD(unreadMessageBadgeText.value), 1)
                                                } else {
                                                    _cC("v-if", true)
                                                }
                                            )),
