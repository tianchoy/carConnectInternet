    ...
    companion object {
        ...
        var setup: (__props: GenPagesWebviewWebview) -> Any? = fun(__props): Any? {
            ...
            onLoad(fun(options){
                ...
                if (url != "") {
                    var decodedUrl: String = decodeURIComponent(url) ?: ""
                    if (!decodedUrl.startsWith("http://") && !decodedUrl.startsWith("https://")) {
                        decodedUrl = "https://" + decodedUrl
                    }
                    webviewUrl.value = decodedUrl
                    if (pageTitle != "") {
                        uni_setNavigationBarTitle(SetNavigationBarTitleOptions(title = decodeURIComponent(pageTitle) ?: ""))
                    } else {
