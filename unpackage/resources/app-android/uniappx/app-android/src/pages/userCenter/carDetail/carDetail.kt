        ...
        var setup: (__props: GenPagesUserCenterCarDetailCarDetail) -> Any? = fun(__props): Any? {
            ...
            val saveChanges = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        val payload: UTSJSONObject = _uO("deviceId" to deviceId.value, "deviceName" to editInfo.value.deviceName, "carType" to editInfo.value.carType, "plateNo" to plateNo, "carVin" to editInfo.value.carVin, "engineNum" to editInfo.value.engineNum)
                        saving.value = true
                    ...
                    _cE("view", _uM("class" to "container"), _uA(
                        ...
                        _cE("view", _uM("class" to "content"), _uA(
                            _cE("view", _uM("class" to "list"), _uA(
                                _cE("text", _uM("class" to "title"), "设备编号"),
                                _cE("text", _uM("class" to "info"), _tD(carInfo.value.getString("deviceNo", "")), 1)
                            )),
                            _cE("view", _uM("class" to "list"), _uA(
