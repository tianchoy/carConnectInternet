        ...
        var setup: (__props: GenPagesCarInfoDetailCarInfoDetail) -> Any? = fun(__props): Any? {
            ...
            val loadData = fun(data: UTSJSONObject, retryCount: Number): UTSPromise<Boolean> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        console.log("loadData", data, retryCount)
                            ...
                            _cE("view", _uM("class" to "imei-box"), _uA(
                                ...
                                _cE("view", _uM("class" to "signal-container"), _uA(
                                    ...
                                    _cE("view", _uM("class" to "satellite-item-h"), _uA(
                                        ...
                                        _cE("text", _uM("class" to "satellite-text"), _tD(if (isTruthy(unref(signalSat))) {
                                            unref(signalSat)
                                        } else {
                                            0
                                        }
