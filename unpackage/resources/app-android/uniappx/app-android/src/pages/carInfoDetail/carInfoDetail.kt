        ...
        var setup: (__props: GenPagesCarInfoDetailCarInfoDetail) -> Any? = fun(__props): Any? {
            ...
            val refreshAdress = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
                        try {
                            val addr = await(getGeocoderAddress(_uO("lat" to center.latitude, "lng" to center.longitude, "deviceId" to deviceId.value)))
                        ...
                        _cE("view", _uM("class" to "tools-panel"), _uA(
                            _cE("view", _uM("class" to "imei-box"), _uA(
                                ...
                                _cE("view", _uM("class" to "pos-date"), _uA(
                                    _cE("text", _uM("class" to "time-item"), "定位时间: " + _tD(unref(datainfo)["positionUpdateTime"]), 1),
                                    _cE("text", _uM("class" to "time-item"), "通信时间: " + _tD(unref(datainfo)["signalUpdateTime"]), 1)
                                )),
                                _cE("view", _uM("class" to "pos-adress"), _uA(
                                    _cE("view", _uM("class" to "address-row"), _uA(
                                        _cE("text", _uM("class" to "address-label", "style" to _nS(_uM("margin-right" to "10rpx", "font-size" to "22rpx"))), "当前位置:", 4),
                                        ...
                                        ,
                                        if (isTrue(!(unref(address) != ""))) {
                                            _cE("text", _uM("key" to 1, "style" to _nS(_uM("color" to "#007AFF", "margin-left" to "20rpx", "font-weight" to "bold", "font-size" to "22rpx")), "onClick" to refreshAdress), "查看中文地址", 4)
                                        } else {
                                            _cC("v-if", true)
                                        }
                                    ))
                                ...
                                _cE("view", _uM("class" to "signal-container"), _uA(
                                    _cE("view", _uM("class" to "signal-item"), _uA(
