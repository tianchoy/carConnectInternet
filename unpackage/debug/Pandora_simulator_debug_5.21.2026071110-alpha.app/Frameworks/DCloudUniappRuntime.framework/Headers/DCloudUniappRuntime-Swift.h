...
/// 获取 webview 视频播放是否全屏
+ (BOOL)getAllowsInlineMediaPlayback SWIFT_WARN_UNUSED_RESULT;
/// 设备是否越狱
...
+ (NSString * _Nonnull)getSnapshotCacheDir SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_NAMED("UniAppRootSceneDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface UniAppRootSceneDelegate : UIResponder <UIWindowSceneDelegate>
@property (nonatomic, strong) UIWindow * _Nullable window;
