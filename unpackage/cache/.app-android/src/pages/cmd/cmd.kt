...
open class GenPagesCmdCmd : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesCmdCmd) -> Any? = fun(__props): Any? {
            ...
            val tabItems = _uA(
                TabItem(name = "下发指令", value = "send"),
                TabItem(name = "指令记录", value = "history")
            ) as UTSArray<TabItem>
            ...
            fun gen_parseParamConfigs_fn(schema: String): UTSArray<UTSJSONObject> {
                ...
                try {
                    val parsed = UTSAndroid.consoleDebugError(JSON.parse(schema), " at pages/cmd/cmd.uvue:359")
                    ...
                    console.error("解析指令参数配置失败:", error, " at pages/cmd/cmd.uvue:386")
            ...
            fun gen_openOptionSheet_fn(index: Number): Unit {
                ...
                getParamOptions(param).forEach(fun(option: UTSJSONObject): Unit {
                    val action = UTSJSONObject(UTSSourceMapPosition("action", "pages/cmd/cmd.uvue", 423, 9))
            ...
            fun gen_loadAvailableCommands_fn(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        try {
                            ...
                            console.error("加载可用指令失败:", error, " at pages/cmd/cmd.uvue:479")
            ...
            fun gen_buildCommandParams_fn(): UTSJSONObject {
                val params = UTSJSONObject(UTSSourceMapPosition("params", "pages/cmd/cmd.uvue", 501, 8))
                run {
                    var index: Number = 0
                    while(index < paramConfigs.value.length){
                        val value = getParamValue(index).trim()
            ...
            fun gen_loadHistoryPage_fn(reset: Boolean): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        try {
                            ...
                            val query = UTSJSONObject(UTSSourceMapPosition("query", "pages/cmd/cmd.uvue", 514, 9))
                            ...
                            console.error("加载指令记录失败:", error, " at pages/cmd/cmd.uvue:530")
            ...
            fun gen_sendSelectedCommand_fn(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        val requestData = UTSJSONObject(UTSSourceMapPosition("requestData", "pages/cmd/cmd.uvue", 556, 8))
                        ...
                        try {
                            ...
                            console.error("下发指令失败:", error, " at pages/cmd/cmd.uvue:573")
            ...
            fun gen_showCommandDetail_fn(record: UTSJSONObject): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        try {
                            ...
                            console.error("加载指令详情失败:", error, " at pages/cmd/cmd.uvue:653")
            ...
            fun gen_retryCommand_fn(commandId: String): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        try {
                            ...
                            console.error("重试下发失败:", error, " at pages/cmd/cmd.uvue:680")
            ...
            fun gen_getEventString_fn(event: Any, key: String): String {
                if (event == null || UTSAndroid.`typeof`(event) != "object") {
                    return ""
                }
                return (event as UTSJSONObject).getString(key, "")
            }
            val getEventString = ::gen_getEventString_fn
            fun gen_changeTab_fn(event: Any): Unit {
                val value = getEventString(event, "value")
                if (value == "") {
                    return
                }
            ...
            fun gen_refreshCurrentTab_fn(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        if (refreshing.value) {
                            return@w1
                        }
            ...
            val refreshCurrentTab = ::gen_refreshCurrentTab_fn
            onLoad(fun(options){
                ...
                return _cE(Fragment, null, _uA(
                    _cE("view", _uM("class" to "page"), _uA(
                        ...
                        _cE("view", _uM("class" to "content-wrap"), _uA(
                            ...
                            _cV(_component_i_tabs, _uM("value" to activeTab.value, "list" to tabItems, "activeColor" to "#1677ff", "inactiveColor" to "#667085", "bgColor" to "#ffffff", "onChange" to fun(`$event`: Any){
                                changeTab(`$event`)
                            }
                            ), null, 8, _uA(
                                "value",
                            ...
                            _cE("scroll-view", _uM("class" to "main-scroll", "scroll-y" to "true", "show-scrollbar" to false, "refresher-enabled" to "", "refresher-triggered" to refreshing.value, "lower-threshold" to 80, "onRefresherrefresh" to refreshCurrentTab, "onScroll" to markHistoryScroll, "onScrolltolower" to loadMoreHistory), _uA(
                                if (deviceId.value == "") {
