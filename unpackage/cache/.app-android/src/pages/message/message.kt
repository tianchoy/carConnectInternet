    ...
    companion object {
        ...
        var setup: (__props: GenPagesMessageMessage) -> Any? = fun(__props): Any? {
            ...
            fun gen_prependLatestMessages_fn(): UTSPromise<Number> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        try {
                            ...
                            console.error("检查新消息失败:", error, " at pages/message/message.uvue:147")
                            return@w1 0
                        }
                         finally {
            ...
            fun gen_startNewMessageCheck_fn(): Unit {
                ...
                console.log("启动定时消息检查", " at pages/message/message.uvue:171")
                checkTimer = setInterval(fun(){
                    if (isPageActive.value) {
                        console.log("定时检查新消息...", " at pages/message/message.uvue:175")
                        checkNewMessages()
                    }
                }
                , 10000)
            ...
            fun loadMsgList(isInit: Boolean = false): UTSPromise<Boolean> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        try {
                            ...
                            loadStatus.value = "loadmore"
                            console.error("请求异常:", error, " at pages/message/message.uvue:232")
                            return@w1 false
                        }
                         finally {
            ...
            fun gen_loadNewMessages_fn(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
                        console.log("加载新消息", " at pages/message/message.uvue:241")
                        await(prependLatestMessages())
                        hasNewMessages.value = false
                        newMessageCount.value = 0
                        console.log("新消息加载完成", " at pages/message/message.uvue:245")
                })
            }
                ...
                return wrapUTSPromise(suspend {
                        ...
                        if (item.getNumber("status", 0) == 1) {
                            try {
                                ...
                                console.error("更新状态失败:", error, " at pages/message/message.uvue:288")
                            }
                        }
                })
            }
            ...
            onShow(fun(){
                ...
                console.log("页面显示 - 启动自动刷新", " at pages/message/message.uvue:324")
                measureMessageScrollViewport()
                resumePageLifecycle()
            }
            )
            onHide(fun(){
                console.log("页面隐藏 - 停止自动刷新", " at pages/message/message.uvue:330")
                finishPageLifecycle()
            }
            )
            onUnload(fun(){
            ...
            onActivated(fun(){
                ...
                console.log("页面激活 - 启动自动刷新", " at pages/message/message.uvue:341")
                resumePageLifecycle()
            }
            )
            onDeactivated(fun(){
                console.log("页面停用 - 停止自动刷新", " at pages/message/message.uvue:346")
                finishPageLifecycle()
            }
            )
            val onRefresherRefresh = fun(){
                console.log("下拉刷新触发", " at pages/message/message.uvue:352")
                        ...
                        _cE("scroll-view", _uM("scroll-y" to "true", "show-scrollbar" to false, "class" to "scroll-container", "id" to "message-scroll-container", "refresher-enabled" to "", "refresher-triggered" to refresherTriggered.value, "lower-threshold" to 100, "onRefresherrefresh" to onRefresherRefresh, "onScrolltolower" to onScrollToLower, "onScroll" to onMessageScroll), _uA(
                            _cE("view", _uM("class" to "list-box"), _uA(
                                if (isTrue(isInitialLoading.value)) {
                                    ...
                                    if (isTrue(hasLoadedInitial.value && msgList.value.length == 0)) {
                                ...
                                if (isTrue(hasNewMessages.value)) {
                                    _cE("view", _uM("key" to 2, "class" to "new-message-tip", "onClick" to loadNewMessages), _uA(
                                ...
                                if (isTrue(showLoadMore.value)) {
                                    _cE("view", _uM("key" to 3, "class" to "load-more"), _uA(
