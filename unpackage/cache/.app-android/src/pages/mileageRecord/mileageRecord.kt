        ...
        var setup: (__props: GenPagesMileageRecordMileageRecord) -> Any? = fun(__props): Any? {
            ...
            val loadMileageData = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        try {
                            val data: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("data", "pages/mileageRecord/mileageRecord.uvue", 211, 10), "imei" to imei.value, "startTime" to startTime.value, "endTime" to endTime.value, "minParkTime" to 120, "withStop" to false, "withPos" to false, "withTrip" to true)
