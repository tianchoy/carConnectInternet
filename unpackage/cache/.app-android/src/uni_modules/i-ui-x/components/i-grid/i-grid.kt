        ...
        var setup: (__props: GenUniModulesIUiXComponentsIGridIGrid) -> Any? = fun(__props): Any? {
            ...
            fun gen_itemValue_fn(item: Any?, keyName: String): String {
                ...
                if (UTSAndroid.`typeof`(item) == "object") {
                    ...
                    val kObject = UTSAndroid.consoleDebugError(JSON.parse(serialized), " at uni_modules/i-ui-x/components/i-grid/i-grid.uvue:168") as UTSJSONObject
            ...
            fun gen_getItemCount_fn(): Number {
            ...
            val getItemCount = ::gen_getItemCount_fn
