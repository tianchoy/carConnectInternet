...
open class GenComponentsSubNavBarSubNavBar : VueComponent {
    ...
    companion object {
                    ...
                    if (isTrue(_ctx.showTime)) {
                        _cE("view", _uM("key" to 0, "class" to "second", "onClick" to fun(){
                            ...
                            _cE("view", _uM("class" to "times"), _uA(
                                _cE("text", _uM("class" to "refresh"), _tD(_ctx.currentTime), 1),
                                if (isTrue(!_ctx.showPickerTime)) {
                                    _cE("text", _uM("key" to 0, "class" to "refresh"), "刷新一次位置")
                                } else {
                                    _cC("v-if", true)
                                }
                            ))
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("tools-box" to _pS(_uM("display" to "flex", "flexDirection" to "row", "justifyContent" to "space-between", "alignItems" to "center", "paddingTop" to "20rpx", "paddingRight" to "30rpx", "paddingBottom" to "20rpx", "paddingLeft" to "30rpx")), "slot" to _uM(".tools-box " to _uM("width" to "50rpx", "height" to "20rpx")), "car-box" to _uM(".tools-box " to _uM("display" to "flex", "flexDirection" to "row", "justifyContent" to "space-between", "alignItems" to "center", "paddingTop" to 0, "paddingRight" to 0, "paddingBottom" to 0, "paddingLeft" to 0)), "selectCar" to _uM(".tools-box .car-box " to _uM("display" to "flex", "flexDirection" to "row", "justifyContent" to "space-between", "alignItems" to "center", "marginRight" to "20rpx", "backgroundColor" to "rgba(3,109,246,0.71)", "paddingTop" to "10rpx", "paddingRight" to "10rpx", "paddingBottom" to "10rpx", "paddingLeft" to "10rpx", "borderTopLeftRadius" to "10rpx", "borderTopRightRadius" to "10rpx", "borderBottomRightRadius" to "10rpx", "borderBottomLeftRadius" to "10rpx")), "plateNo" to _uM(".tools-box .car-box .selectCar " to _uM("fontSize" to "30rpx", "color" to "#ffffff")), "car-state" to _uM(".tools-box .car-box " to _uM("display" to "flex", "flexDirection" to "row", "justifyContent" to "space-between", "alignItems" to "center", "borderTopLeftRadius" to "10rpx", "borderTopRightRadius" to "10rpx", "borderBottomRightRadius" to "10rpx", "borderBottomLeftRadius" to "10rpx", "paddingTop" to "10rpx", "paddingRight" to "15rpx", "paddingBottom" to "10rpx", "paddingLeft" to "15rpx")), "state" to _uM(".tools-box .car-box .car-state " to _uM("fontSize" to "25rpx", "color" to "#ffffff")), "success" to _uM(".tools-box .car-box " to _uM("backgroundColor" to "#5ac725")), "error" to _uM(".tools-box .car-box " to _uM("backgroundColor" to "#f56c6c")), "second" to _uM(".tools-box " to _uM("display" to "flex", "flexDirection" to "row", "justifyContent" to "space-between", "alignItems" to "center", "paddingTop" to "10rpx", "paddingRight" to "10rpx", "paddingBottom" to "10rpx", "paddingLeft" to "10rpx", "backgroundColor" to "rgba(3,109,246,0.71)", "borderTopLeftRadius" to "10rpx", "borderTopRightRadius" to "10rpx", "borderBottomRightRadius" to "10rpx", "borderBottomLeftRadius" to "10rpx")), "times" to _uM(".tools-box .second " to _uM("display" to "flex", "flexDirection" to "row", "justifyContent" to "flex-start", "alignItems" to "center")), "refresh" to _uM(".tools-box .second .times " to _uM("fontSize" to "30rpx", "color" to "#ffffff")), "down_icon" to _uM(".tools-box " to _uM("width" to "30rpx", "height" to "30rpx")))
            }
