...
open class GenComponentsIndexListModeIndexListMode : VueComponent {
    ...
    companion object {
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to "list-container"), _uA(
                    if (props.lists.length != 0) {
                        _cE("view", _uM("key" to 0, "class" to "content"), _uA(
                                ...
                                return _cE("view", _uM("class" to "list-item", "key" to index, "onClick" to fun(){
                                    ...
                                    _cE("view", _uM("class" to "title"), _uA(
                                        _cE("view", _uM("class" to "car-number"), _uA(
                                            _tD(item.deviceName) + " ",
                                            _cV(_component_i_tag, _uM("size" to "mini", "shape" to "circle", "text" to if (item.connectionStatus == "online") {
                                                "在线"
                                            } else {
                                                "离线"
                                        ...
                                        _cE("view", _uM("class" to "device-tools"), _uA(
                                            ...
                                            _cV(_component_i_tag, _uM("text" to "解绑", "type" to "warning", "onClick" to withModifiers(fun(){
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("list-container" to _pS(_uM("width" to "100%", "backgroundColor" to "#f5f5f5", "paddingTop" to 0, "paddingRight" to "20rpx", "paddingBottom" to 0, "paddingLeft" to "20rpx")), "content" to _uM(".list-container " to _uM("overflowY" to "auto")), "list-item" to _uM(".list-container .content " to _uM("paddingTop" to "20rpx", "paddingRight" to "20rpx", "paddingBottom" to "20rpx", "paddingLeft" to "20rpx", "backgroundColor" to "#ffffff", "borderTopLeftRadius" to "10rpx", "borderTopRightRadius" to "10rpx", "borderBottomRightRadius" to "10rpx", "borderBottomLeftRadius" to "10rpx", "marginBottom" to "20rpx")), "title" to _uM(".list-container .content .list-item " to _uM("display" to "flex", "flexDirection" to "row", "justifyContent" to "space-between", "alignItems" to "center", "marginBottom" to "20rpx")), "car-number" to _uM(".list-container .content .list-item .title " to _uM("display" to "flex", "fontSize" to "35rpx", "marginRight" to "20rpx", "flexDirection" to "row", "justifyContent" to "center", "alignItems" to "center", "gap" to "10rpx")), "device-tools" to _uM(".list-container .content .list-item .title " to _uM("display" to "flex", "flexDirection" to "row", "justifyContent" to "flex-end", "alignItems" to "center", "gap" to "10rpx")), "imei" to _uM(".list-container .content .list-item " to _uM("color" to "#cccccc")), "empty" to _uM(".list-container " to _uM("display" to "flex", "flexDirection" to "row", "justifyContent" to "center", "alignItems" to "center", "color" to "#cccccc")))
            }
